...
- **Generated artifact lifecycle:** ARB sources and Drift schema snapshots are tracked; derivable Dart outputs are ignored and regenerated by the canonical Makefile targets before checks.
