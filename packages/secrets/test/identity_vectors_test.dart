...
void main() {
  ...
  test('the passphrase changes every one of them', () {
    final plain = vectors[0];
    final withPassphrase = vectors[1];
    expect(withPassphrase.id, isNot(plain.id));
    expect(withPassphrase.zpub, isNot(plain.zpub));
    expect(withPassphrase.bip85At0, isNot(plain.bip85At0));
  });
}
