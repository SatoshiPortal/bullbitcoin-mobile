...
class BullPasteInput extends StatelessWidget {
  ...
  /// Handles edits, and pastes when [onCompleted] is not supplied.
  final ValueChanged<String> onChanged;

  /// Handles a completed paste or submission separately from edits.
  ...
  Future<void> _paste() async {
    try {
      ...
      if (value?.text case final text?) (onCompleted ?? onChanged)(text);
