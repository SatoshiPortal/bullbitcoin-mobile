...
// consumer's test cannot mock it: substituting Orbot means substituting the
// port. Published here rather than from `tor.dart` because a feature must
// keep going through the use-case.
