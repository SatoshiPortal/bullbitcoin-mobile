...
class OrderSwapRecord {
  ...
  /// The swap provider that created this order: `'bull'` (exchange) or
  /// `'boltz'`. Stamped at creation and preserved across refreshes.
