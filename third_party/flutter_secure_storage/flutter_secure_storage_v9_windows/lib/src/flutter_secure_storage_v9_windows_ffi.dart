...
class FlutterSecureStorageV9Windows extends FlutterSecureStorageV9Platform {
  final FlutterSecureStorageV9Platform _backwardCompatible;
  ...
  FlutterSecureStorageV9Windows._(
...
@visibleForTesting
FlutterSecureStorageV9Windows createFlutterSecureStorageV9Windows(
  FlutterSecureStorageV9Platform backwardCompatible,
  MapStorage mapStorage,
) =>
    FlutterSecureStorageV9Windows._(backwardCompatible, mapStorage);
...
@visibleForTesting
const String encryptedJsonFileName = 'flutter_secure_storage_v9.dat';
