...
import 'package:flutter_secure_storage_v9_windows/src/flutter_secure_storage_v9_windows_ffi.dart'
    as ffi;
import 'package:flutter_secure_storage_v9_windows/src/flutter_secure_storage_v9_windows_ffi.dart';
import 'package:flutter_secure_storage_v9_windows/src/flutter_secure_storage_v9_windows_stub.dart'
    as stub;
...
void main() {
  ...
  group('Basic test cases', () {
    FlutterSecureStorageV9Platform createTarget() {
      TestWidgetsFlutterBinding.instance.defaultBinaryMessenger
          .setMockMethodCallHandler(
        const MethodChannel('plugins.it_nomads.com/flutter_secure_storage_v9'),
        (methodCall) async {
          assert(false, 'MethodChanel is called.');
          return null;
        },
      );
      return ffi.FlutterSecureStorageV9Windows();
    }
  ...
  group('Backwards compatibilty cases', () {
    FlutterSecureStorageV9Platform createTarget(
      ...
      return ffi.createFlutterSecureStorageV9Windows(
