...
import 'package:flutter_secure_storage_v9_windows/flutter_secure_storage_v9_windows.dart';
...
class MyAppState extends State<MyApp> {
  ...
  FlutterSecureStorageV9Platform _flutterSecureStorageWindowsPlugin =
  ...
  void doLegacyWrite() => doTest(() async {
        ...
        final value = valueFieldController.text.isNotEmpty
            ? valueFieldController.text
            : DateTime.now().toIso8601String();
        // call MethodChannelFlutterSecureStorageV9 directly
        final legacyStorage = MethodChannelFlutterSecureStorageV9();
