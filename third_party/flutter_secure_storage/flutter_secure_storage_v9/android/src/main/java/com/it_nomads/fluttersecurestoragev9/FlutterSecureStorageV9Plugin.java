package com.it_nomads.fluttersecurestoragev9;
...
public class FlutterSecureStorageV9Plugin implements MethodCallHandler, FlutterPlugin {

    private static final String TAG = "FlutterSecureStorageV9Pl";
    private MethodChannel channel;
    private FlutterSecureStorageV9 secureStorage;
    private HandlerThread workerThread;
    private Handler workerThreadHandler;

    public void initInstance(BinaryMessenger messenger, Context context) {
        try {
            secureStorage = new FlutterSecureStorageV9(context, new HashMap<>());

            workerThread = new HandlerThread("com.it_nomads.fluttersecurestoragev9.worker");
            workerThread.start();
            workerThreadHandler = new Handler(workerThread.getLooper());

            channel = new MethodChannel(messenger, "plugins.it_nomads.com/flutter_secure_storage_v9");
