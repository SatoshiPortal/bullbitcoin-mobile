...
final storage = FlutterSecureStorageV9(aOptions: _getAndroidOptions());
```

This will prevent errors due to mixed usage of `encryptedSharedPreferences`.
For more info, [see this issue](https://github.com/mogol/flutter_secure_storage_v9/issues/487#issuecomment-1346244368).
