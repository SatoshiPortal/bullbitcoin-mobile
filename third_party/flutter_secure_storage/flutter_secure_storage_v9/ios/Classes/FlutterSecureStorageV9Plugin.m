#import "FlutterSecureStorageV9Plugin.h"
#if __has_include(<flutter_secure_storage_v9/flutter_secure_storage_v9-Swift.h>)
#import <flutter_secure_storage_v9/flutter_secure_storage_v9-Swift.h>
#else
// Support project import fallback if the generated compatibility header
// is not copied when this plugin is created as a library.
// https://forums.swift.org/t/swift-static-libraries-dont-copy-generated-objective-c-header/19816
#import "flutter_secure_storage_v9-Swift.h"
#endif

@implementation FlutterSecureStorageV9Plugin
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  [SwiftFlutterSecureStorageV9Plugin registerWithRegistrar:registrar];
}
@end
...
//#import "FlutterSecureStorageV9Plugin.h"
//
//static NSString *const CHANNEL_NAME = @"plugins.it_nomads.com/flutter_secure_storage_v9";
//
//static NSString *const InvalidParameters = @"Invalid parameter's type";
//
//@interface FlutterSecureStorageV9Plugin()
//
...
//    FlutterSecureStorageV9Plugin* instance = [[FlutterSecureStorageV9Plugin alloc] init];
