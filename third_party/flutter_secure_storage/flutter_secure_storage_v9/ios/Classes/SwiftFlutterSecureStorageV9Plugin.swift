//
//  SwiftFlutterSecureStorageV9Plugin.swift
...
public class SwiftFlutterSecureStorageV9Plugin: NSObject, FlutterPlugin, FlutterStreamHandler {

    private let flutterSecureStorageManager: FlutterSecureStorageV9 = FlutterSecureStorageV9()
    private var secStoreAvailabilitySink: FlutterEventSink?

    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "plugins.it_nomads.com/flutter_secure_storage_v9", binaryMessenger: registrar.messenger())
        let eventChannel = FlutterEventChannel(name: "plugins.it_nomads.com/flutter_secure_storage_v9/events", binaryMessenger: registrar.messenger())
        let instance = SwiftFlutterSecureStorageV9Plugin()
    ...
    private func parseCall(_ call: FlutterMethodCall) -> FlutterSecureStorageV9Request {
        ...
        return FlutterSecureStorageV9Request(
    ...
    private func handleResponse(_ response: FlutterSecureStorageV9Response, _ result: @escaping FlutterResult) {
    ...
    struct FlutterSecureStorageV9Request {
