library flutter_secure_storage_v9;

import 'dart:io';

import 'package:flutter/foundation.dart';
import 'package:flutter/services.dart';
import 'package:flutter_secure_storage_v9/test/test_flutter_secure_storage_v9_platform.dart';
...
class FlutterSecureStorageV9 {
  ...
  FlutterSecureStorageV9Platform get _platform =>
  ...
  Stream<bool>? get onCupertinoProtectedDataAvailabilityChanged =>
      _platform is MethodChannelFlutterSecureStorageV9
          ? (_platform as MethodChannelFlutterSecureStorageV9)
  ...
  Future<bool?> isCupertinoProtectedDataAvailable() async =>
      _platform is MethodChannelFlutterSecureStorageV9
          ? await (_platform as MethodChannelFlutterSecureStorageV9)
  ...
  static void setMockInitialValues(Map<String, String> values) {
    FlutterSecureStorageV9Platform.instance =
        TestFlutterSecureStorageV9Platform(values);
  }
}
