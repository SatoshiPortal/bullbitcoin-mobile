...
import 'package:bb_mobile/core_deprecated/swaps/data/models/swap_model.dart';
import 'package:bb_mobile/core_deprecated/swaps/domain/entity/swap.dart' as swap_entity;
...
class BoltzDatasource {
  ...
  Future<void> _processWebSocketEvent(
    ...
    final swapExpired = swapModel.status == swap_entity.SwapStatus.expired.name;
    // final isLnSwap =
