      ...
      child: Column(
        ...
        children: [
          if (sent) ...[
            ...
            const Center(child: BBText.title('Fees Bumped Successfully'))
                .animate()
                .fadeIn(),
            const Gap(32),
            const Center(
              child: BBText.bodySmall('You will be redirected in 2 seconds'),
            ),
          ] else ...[
            ...
            BBButton.big(
              ...
              onPressed: () {
                // if (!built)
                final fees =
                    context.read<NetworkFeesCubit>().state.feesForBump();
                context.read<TransactionCubit>().buildTx(fees);
                // else
