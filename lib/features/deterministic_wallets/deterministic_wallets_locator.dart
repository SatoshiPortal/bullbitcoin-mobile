  ...
  static void setup(GetIt locator) {
    ...
    locator.registerFactory<PrepareDeterministicWalletsUsecase>(
      () => PrepareDeterministicWalletsUsecase(
        ...
        walletRepository: locator<DeterministicWalletRepository>(),
      ),
    );
    locator.registerFactory<DeterministicWalletsFacade>(() {
      final prepareWallets = locator<PrepareDeterministicWalletsUsecase>();
      return DeterministicWalletsFacade(
        prepareWallets: prepareWallets.execute,
        rollbackWallets: prepareWallets.rollbackCreatedWallets,
      );
    });
  }
}
