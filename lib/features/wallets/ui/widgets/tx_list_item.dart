...
class TxListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final walletColor = isOrderType
        ...
        : tx.isOngoingSwap
        ? context.appColors.secondaryContainer.withValues(alpha: 0.3)
        : tx.isBitcoin
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: tx.isOngoingSwap
                    ? context.appColors.secondaryContainer.withValues(
                        alpha: 0.3,
                      )
              ...
              child: Column(
                ...
                children: [
                  CurrencyText(
                    ...
                    fiatAmount: isOrderType && showOrderInFiat
                        ? orderAmountAndCurrency!.$1.toDouble()
                        : null,
                    fiatCurrency: isOrderType && showOrderInFiat
