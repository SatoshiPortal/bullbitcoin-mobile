...
BTCPay, Lightning Address, and Payment Page wallet seed reservations. Bullnym-
backed materializations are recoverable, but each owning product flow must
verify server state after recovery. Other reserved
