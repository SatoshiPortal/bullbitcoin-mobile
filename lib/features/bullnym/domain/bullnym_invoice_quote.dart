enum BullnymPayerQuoteRail {
  ...
  static BullnymPayerQuoteRail? fromWire(String value) {
    for (final rail in values) {
      if (rail.wire == value) return rail;
    }
    return null;
  }
}

final class BullnymPayerQuoteRailAvailability {
...
final class BullnymPayerDemandQuoteResponse {
