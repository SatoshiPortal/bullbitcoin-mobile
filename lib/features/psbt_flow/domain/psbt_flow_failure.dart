...
/// The PSBT was readable but no QR came out of it: the encoder threw, or it
/// returned nothing (a well-formed PSBT always yields at least one part, so an
/// empty result is a failure, not an empty state).
final class PsbtFlowQrEncodingFailure extends PsbtFlowFailure {
  const PsbtFlowQrEncodingFailure([super.logMessage]);
}
