...
class SendCubit extends Cubit<SendState>
        ...
        case Ok(:final value):
          ...
          if (stored.isDraft) {
            emit(
              state.copyWith(
                ...
                fiatCurrencyCode:
                    value.fiatCurrencyCode ?? state.fiatCurrencyCode,
          ...
          emit(
            state.copyWith(
              ...
              signedBitcoinPsbt:
                  stored.isReadyToBroadcast && stored.finalTransaction == null
                  ? stored.psbt
                  : null,
  ...
  Future<void> loadUtxos() async {
    ...
    try {
      ...
      if (isClosed || state.selectedWallet?.id != wallet.id) return;
  ...
  Future<bool> updateSignedBitcoinTx(String signedTx) =>
      applyFinalBitcoinTransaction(signedTx);

  Future<bool> updateBitcoinSignerResult(String signerResult) =>
      applyExternalBitcoinSigningResult(signerResult);
