...
class ImportWatchOnlyXpubUsecase {
  ...
  Future<Result<Wallet, ImportWatchOnlyFailure>> execute({
    ...
    if (bitcoinSyncBackend == BitcoinSyncBackend.compactBlockFilters) {
      final isTestnet = watchOnlyXpub.network.isTestnet;
  ...
  /// actually open. Xpub import is Bitcoin-only, so
  /// [WalletRepository.importWatchOnlyXpub] always persists this result
  /// unlike its descriptor counterpart.
