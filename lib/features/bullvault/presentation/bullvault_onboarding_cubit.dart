...
final class BullVaultOnboardingCubit extends Cubit<BullVaultOnboardingState> {
  ...
  void _restoreCompletionState(
    ...
    final step = !result.record.recoveryPackageVerified
    ...
    emit(
      state.copyWith(
        ...
        recoveryPackageConfirmed: result.record.recoveryPackageVerified,
    ...
    emit(
      state.copyWith(
        ...
        secondColdInput: protection.usesTwoColdKeys
            ...
            : '',
        schedule: state.schedule.forConfiguration(
          currentProtection: state.protection,
          currentlyIncludesInheritance: state.includeInheritance,
          protection: protection,
    ...
    emit(
      state.copyWith(
        ...
        schedule: state.schedule
            ...
            .copyWith(
              lastResortDelay: value && !state.includeInheritance
  ...
  void setLastResortRecovery(bool enabled) => emit(
    state.copyWith(
      schedule: state.schedule.copyWith(
        lastResortDelay: enabled && state.includeInheritance
            ? BullVaultSchedule.defaultLastResortDelay
            : null,
        clearLastResortDelay: !enabled || !state.includeInheritance,
      ),
      clearTimeReference: true,
      clearFailure: true,
    ),
  ...
  void setLastResortDelay(int value) => emit(
    state.copyWith(
      schedule: state.schedule.copyWith(lastResortDelay: value),
      clearTimeReference: state.step != BullVaultOnboardingStep.review,
      clearFailure: true,
    ),
  );
