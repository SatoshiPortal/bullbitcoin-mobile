...
class TorSettingsLocator {
  static void setup() {
    ...
    // Use cases
    locator.registerLazySingleton<CheckTorConnectionUsecase>(
      () => CheckTorConnectionUsecase(
        socketPort: locator<SocketPort>(),
      ),
    );
    ...
    locator.registerFactory<TorSettingsCubit>(
      () => TorSettingsCubit(
        ...
        checkTorConnectionUsecase: locator<CheckTorConnectionUsecase>(),
      ),
    );
  }
}
