...
abstract final class SpRecipientMapper {
  static bwk.RecipientView toFfi(SpRecipient recipient) => switch (recipient) {
    SpRecipientSp(:final address, :final amountSat, :final label, :final isMax) =>
  ...
  static SpRecipient toDomain(bwk.RecipientView view) => switch (view) {
    bwk.RecipientView_Sp(:final address, :final amountSat, :final label, :final isMax) =>
      SpRecipientSp(
        address: address,
        amountSat: amountSat,
        label: label,
    ...
    bwk.RecipientView_Standard(:final address, :final amountSat, :final isMax) =>
