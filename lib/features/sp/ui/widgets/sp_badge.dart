...
import 'package:bull_ui/bull_ui.dart' show BullBadge, BullRadius;
...
(String, Color) spAddressKindBadge(BuildContext context, SpAddressKind kind) =>
    switch (kind) {
      ...
      SpAddressKind.bitcoinMainnet ||
      SpAddressKind.bitcoinTestnet ||
      SpAddressKind.bitcoinRegtest ||
      SpAddressKind.bitcoinLegacyNonMainnet => (
