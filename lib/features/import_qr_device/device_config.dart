...
class DeviceConfig {
  ...
  static final Map<SignerDeviceEntity, DeviceConfig> configs = {
    SignerDeviceEntity.jade: DeviceConfig(
      ...
      getInstructionsTitle:
          (context) => context.loc.importQrDeviceJadeInstructionsTitle,
      getInstructions:
          (context) => [
    ...
    SignerDeviceEntity.krux: DeviceConfig(
      ...
      getInstructionsTitle:
          (context) => context.loc.importQrDeviceKruxInstructionsTitle,
      getInstructions:
          (context) => [
    ...
    SignerDeviceEntity.keystone: DeviceConfig(
      ...
      getInstructionsTitle:
          (context) => context.loc.importQrDeviceKeystoneInstructionsTitle,
      getInstructions:
          (context) => [
    ...
    SignerDeviceEntity.passport: DeviceConfig(
      ...
      getInstructionsTitle:
          (context) => context.loc.importQrDevicePassportInstructionsTitle,
      getInstructions:
          (context) => [
    ...
    SignerDeviceEntity.seedsigner: DeviceConfig(
      ...
      getInstructionsTitle:
          (context) => context.loc.importQrDeviceSeedsignerInstructionsTitle,
      getInstructions:
          (context) => [
    ...
    SignerDeviceEntity.specter: DeviceConfig(
      ...
      getInstructionsTitle:
          (context) => context.loc.importQrDeviceSpecterInstructionsTitle,
      getInstructions:
          (context) => [
