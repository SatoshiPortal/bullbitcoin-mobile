...
class BackupSettingsCubit extends Cubit<BackupSettingsState> {
  ...
  Future<void> exportVault() async {
    try {
      ...
      final backupFile = await _createEncryptedVaultUsecase.execute();
      ...
      final fileName = 'vault_${DateTime.now().millisecondsSinceEpoch}.txt';
      final filePath = '$folderPath/$fileName';

      await _saveToFileSystemUsecase.execute(filePath, backupFile);
