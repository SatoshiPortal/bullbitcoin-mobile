...
final class Schema13 extends i0.VersionedSchema {
  ...
  late final Shape37 appSettings = Shape37(
    source: i0.VersionedTable(
...
class Shape37 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get id =>
      columnsByName['id']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get fiatCurrencyCode =>
      columnsByName['fiat_currency_code']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get bitcoinUnit =>
      columnsByName['bitcoin_unit']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get languageTag =>
      columnsByName['language_tag']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get themeMode =>
      columnsByName['theme_mode']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get hideAmounts =>
      columnsByName['hide_amounts']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get environmentMode =>
      columnsByName['environment_mode']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get superuserModeEnabled =>
      columnsByName['superuser_mode_enabled']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get featureLevel =>
      columnsByName['feature_level']! as i1.GeneratedColumn<String>;
}
...
i1.GeneratedColumn<String> _column_235(String aliasedName) =>
    i1.GeneratedColumn<String>(
      ...
      defaultValue: const i1.CustomExpression('\'CAD\''),
    );
i1.GeneratedColumn<String> _column_236(String aliasedName) =>
    i1.GeneratedColumn<String>(
      ...
      defaultValue: const i1.CustomExpression('\'btc\''),
    );
...
i1.GeneratedColumn<String> _column_239(String aliasedName) =>
    i1.GeneratedColumn<String>(
      ...
      defaultValue: const i1.CustomExpression('\'production\''),
    );
...
i1.GeneratedColumn<String> _column_241(String aliasedName) =>
    i1.GeneratedColumn<String>(
      ...
      defaultValue: const i1.CustomExpression('\'stable\''),
    );
