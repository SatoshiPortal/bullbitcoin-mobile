...
final class Schema14 extends i0.VersionedSchema {
  ...
  late final Shape40 autoSwap = Shape40(
    source: i0.VersionedTable(
      entityName: 'auto_swap',
      withoutRowId: false,
      isStrict: false,
  ...
  late final Shape41 dismissedAnnouncements = Shape41(
    source: i0.VersionedTable(
      ...
      columns: [_column_243, _column_244],
      attachedDatabase: database,
    ),
    alias: null,
  );
...
class Shape40 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get showWarning =>
      columnsByName['show_warning']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get boltzFallbackUrl =>
      columnsByName['boltz_fallback_url']! as i1.GeneratedColumn<String>;
}
