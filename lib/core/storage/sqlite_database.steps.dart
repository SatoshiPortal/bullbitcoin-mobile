...
final class Schema2 extends i0.VersionedSchema {
  ...
  late final Shape1 v5MigrateWalletMetadatas = Shape1(
    source: i0.VersionedTable(
      entityName: 'v5_migrate_wallet_metadatas',
      withoutRowId: false,
      isStrict: false,
  ...
  late final Shape2 labels = Shape2(
    source: i0.VersionedTable(
      ...
      columns: [_column_24, _column_26, _column_27, _column_28, _column_29],
      attachedDatabase: database,
    ),
    alias: null,
  );
...
i1.GeneratedColumn<BigInt> _column_52(String aliasedName) =>
...
i1.GeneratedColumn<i2.Uint8List> _column_53(String aliasedName) =>
