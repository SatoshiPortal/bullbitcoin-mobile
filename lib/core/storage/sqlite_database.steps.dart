...
class Shape40 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get birthday =>
      columnsByName['birthday']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get bitcoinSyncBackend =>
      columnsByName['bitcoin_sync_backend']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get lastReceiveAddressIndex =>
      columnsByName['last_receive_address_index']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get birthdayBlockTimestamp =>
      columnsByName['birthday_block_timestamp']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get birthdayBlockHeight =>
      columnsByName['birthday_block_height']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get birthdayBlockHash =>
      columnsByName['birthday_block_hash']! as i1.GeneratedColumn<String>;
}
...
i1.GeneratedColumn<String> _column_242(String aliasedName) =>
    i1.GeneratedColumn<String>(
      ...
      defaultValue: const i1.CustomExpression('\'electrum\''),
    );
...
class Shape41 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get exchangeTestnetBasicAuthPassword =>
      columnsByName['exchange_testnet_basic_auth_password']!
          as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get useCompactBlockFiltersByDefault =>
      columnsByName['use_compact_block_filters_by_default']!
          as i1.GeneratedColumn<int>;
}

i1.GeneratedColumn<int> _column_247(
  String aliasedName,
) => i1.GeneratedColumn<int>(
