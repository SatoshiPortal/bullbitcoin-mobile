...
final class Schema16 extends i0.VersionedSchema {
  ...
  late final Shape43 sendTimestamps = Shape43(
    source: i0.VersionedTable(
      entityName: 'send_timestamps',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: ['PRIMARY KEY(txid)'],
      columns: [_column_114, _column_288],
      attachedDatabase: database,
    ),
    alias: null,
  );
...
class Shape43 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get txid =>
      columnsByName['txid']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get sentAtSecs =>
      columnsByName['sent_at_secs']! as i1.GeneratedColumn<int>;
}
