...
class Shape38 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get claimFees =>
      columnsByName['claim_fees']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get refundFees =>
      columnsByName['refund_fees']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get serverNetworkFees =>
      columnsByName['server_network_fees']! as i1.GeneratedColumn<int>;
...
final class Schema16 extends i0.VersionedSchema {
  ...
  late final Shape43 walletMetadatas = Shape43(
    source: i0.VersionedTable(
      entityName: 'wallet_metadatas',
      withoutRowId: false,
      isStrict: false,
  ...
  late final Shape44 walletSigners = Shape44(
    source: i0.VersionedTable(
      entityName: 'wallet_signers',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: [
  ...
  late final Shape45 walletDescriptorKeys = Shape45(
    source: i0.VersionedTable(
      entityName: 'wallet_descriptor_keys',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: [
        'PRIMARY KEY(wallet_id, id)',
  ...
  late final Shape47 sendTransactionInputs = Shape47(
    source: i0.VersionedTable(
      ...
      columns: [_column_311, _column_240, _column_241],
      attachedDatabase: database,
    ),
    alias: null,
  );
  late final Shape48 sendTransactionPolicyChoices = Shape48(
    source: i0.VersionedTable(
      ...
      columns: [_column_311, _column_312, _column_313],
      attachedDatabase: database,
    ),
    alias: null,
  );
...
class Shape43 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get latestPhysicalBackup =>
      columnsByName['latest_physical_backup']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get publicDescriptor =>
      columnsByName['public_descriptor']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get isDefault =>
      columnsByName['is_default']! as i1.GeneratedColumn<int>;
...
class Shape44 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get signerDevice =>
      columnsByName['signer_device']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get registrationName =>
      columnsByName['registration_name']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get localSeedFingerprint =>
      columnsByName['local_seed_fingerprint']! as i1.GeneratedColumn<String>;
}

i1.GeneratedColumn<int> _column_290(String aliasedName) =>
    i1.GeneratedColumn<int>(
      'position',
      aliasedName,
      false,
...
class Shape45 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get position =>
      columnsByName['position']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get signerId =>
      columnsByName['signer_id']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get masterFingerprint =>
      columnsByName['master_fingerprint']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get xpubFingerprint =>
      columnsByName['xpub_fingerprint']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get xpub =>
      columnsByName['xpub']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get derivationPath =>
      columnsByName['derivation_path']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get descriptorPath =>
      columnsByName['descriptor_path']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get requiresPassphrase =>
      columnsByName['requires_passphrase']! as i1.GeneratedColumn<int>;
}
...
i1.GeneratedColumn<String> _column_302(String aliasedName) =>
    i1.GeneratedColumn<String>(
      'fee_selection',
      aliasedName,
      false,
...
i1.GeneratedColumn<int> _column_305(String aliasedName) =>
    i1.GeneratedColumn<int>(
      'replace_by_fee',
      aliasedName,
      false,
...
i1.GeneratedColumn<String> _column_309(String aliasedName) =>
    i1.GeneratedColumn<String>(
      'updated_at',
      aliasedName,
      false,
...
final class Schema17 extends i0.VersionedSchema {
  ...
  late final Shape51 walletMetadatas = Shape51(
    source: i0.VersionedTable(
      entityName: 'wallet_metadatas',
      withoutRowId: false,
      isStrict: false,
  ...
  late final Shape52 keychainManifestEntries = Shape52(
    source: i0.VersionedTable(
      entityName: 'keychain_manifest_entries',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: ['PRIMARY KEY(entry_id)'],
      columns: [
        _column_333,
        _column_334,
        _column_335,
  ...
  late final Shape53 keychainManifestWalletBindings = Shape53(
    source: i0.VersionedTable(
  ...
  late final Shape54 keychainManifestNostrKeys = Shape54(
    source: i0.VersionedTable(
      entityName: 'keychain_manifest_nostr_keys',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: ['PRIMARY KEY(entry_id)'],
      columns: [
  ...
  late final Shape55 walletBackupStates = Shape55(
    source: i0.VersionedTable(
...
class Shape51 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get isHidden =>
      columnsByName['is_hidden']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get hideOnHome =>
      columnsByName['hide_on_home']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get autoSweepEnabled =>
      columnsByName['auto_sweep_enabled']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get label =>
      columnsByName['label']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get syncedAt =>
      columnsByName['synced_at']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get birthday =>
      columnsByName['birthday']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get provenance =>
      columnsByName['provenance']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get seedPassphraseUsed =>
      columnsByName['seed_passphrase_used']! as i1.GeneratedColumn<int>;
}
...
i1.GeneratedColumn<String> _column_331(String aliasedName) =>
    i1.GeneratedColumn<String>(
      ...
      defaultValue: const i1.CustomExpression('\'watchOnly\''),
    );
...
class Shape52 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get derivationKind =>
      columnsByName['derivation_kind']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get derivationPath =>
      columnsByName['derivation_path']! as i1.GeneratedColumn<String>;
...
class Shape53 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get entryId =>
      columnsByName['entry_id']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get childSeedFingerprint =>
  ...
  i1.GeneratedColumn<int> get seedPassphraseUsed =>
      columnsByName['seed_passphrase_used']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get descriptor =>
      columnsByName['descriptor']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get label =>
      columnsByName['label']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get createdAt =>
      columnsByName['created_at']! as i1.GeneratedColumn<int>;
...
class Shape54 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get entryId =>
      columnsByName['entry_id']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get publicKeyHex =>
      columnsByName['public_key_hex']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get keyKind =>
...
class Shape55 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get uploadedRevision =>
      columnsByName['uploaded_revision']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get lastSucceededAt =>
      columnsByName['last_succeeded_at']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get lastRecoveryStatus =>
      columnsByName['last_recovery_status']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get unsupportedVersion =>
      columnsByName['unsupported_version']! as i1.GeneratedColumn<int>;
...
i1.GeneratedColumn<int> _column_347(String aliasedName) =>
    i1.GeneratedColumn<int>(
      'enabled',
      aliasedName,
      false,
...
i1.GeneratedColumn<int> _column_348(String aliasedName) =>
    i1.GeneratedColumn<int>(
      'local_revision',
      aliasedName,
      false,
...
i1.GeneratedColumn<int> _column_350(String aliasedName) =>
    i1.GeneratedColumn<int>(
      'last_succeeded_at',
      aliasedName,
      true,
...
i1.GeneratedColumn<int> _column_352(String aliasedName) =>
    i1.GeneratedColumn<int>(
      'unsupported_version',
      aliasedName,
      true,
...
i1.GeneratedColumn<int> _column_355(String aliasedName) =>
    i1.GeneratedColumn<int>(
      'remote_generation',
      aliasedName,
      true,
...
i1.GeneratedColumn<String> _column_356(String aliasedName) =>
    i1.GeneratedColumn<String>(
      'remote_etag',
      aliasedName,
      true,
