...
final class Schema13 extends i0.VersionedSchema {
  ...
  late final Shape35 secretUsages = Shape35(
    source: i0.VersionedTable(
      entityName: 'secret_usages',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: [
...
class Shape35 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get consumerType =>
      columnsByName['consumer_type']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get walletId =>
      columnsByName['wallet_id']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get bip85Path =>
      columnsByName['bip85_path']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get createdAt =>
      columnsByName['created_at']! as i1.GeneratedColumn<String>;
}
