...
class StoreVaultKeyIntoServerUsecase {
  ...
  Future<void> execute({
    ...
    try {
      ...
      log.severe('$StoreVaultKeyIntoServerUsecase: $e', trace: StackTrace.current);
      throw ServerError.fromException(e);
    } catch (e) {
      if (e is! ServerError) log.severe('$StoreVaultKeyIntoServerUsecase: $e', trace: StackTrace.current);
