...
/// attack signal.
///
/// The server answers every service-wide limit with 503 — exhausted global
/// bucket, full rate-limit map, or the reverse proxy's own edge limit — so
/// there is a single [serviceBusy] kind rather than one per bucket.
/// [mapNearlyFull] is different in nature: it is not an error response but a
/// capacity reading taken from a *successful* snapshot.
