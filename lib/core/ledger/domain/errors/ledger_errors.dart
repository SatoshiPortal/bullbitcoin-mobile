...
sealed class LedgerError with _$LedgerError {
  ...
  const factory LedgerError.multipleDevicesFound() =
      MultipleDevicesFoundLedgerError;
  const factory LedgerError.deviceNotFound() = DeviceNotFoundLedgerError;
  const factory LedgerError.connectionTypeNotInitialized() =
      ConnectionTypeNotInitializedLedgerError;
  const factory LedgerError.noActiveConnection() =
      NoActiveConnectionLedgerError;
  ...
  const factory LedgerError.operationFailed({required String message}) =
      OperationFailedLedgerError;
