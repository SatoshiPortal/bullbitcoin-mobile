...
class $AssetsImages2Gen {
  ...
  /// File path: assets/images2/bb-sync.gif
  AssetGenImage get bbSync => const AssetGenImage('assets/images2/bb-sync.gif');

  /// File path: assets/images2/bg-red.png
  AssetGenImage get bgRed => const AssetGenImage('assets/images2/bg-red.png');

  /// File path: assets/images2/bg_instant_wallet.png
  AssetGenImage get bgInstantWallet =>
      const AssetGenImage('assets/images2/bg_instant_wallet.png');

  /// File path: assets/images2/bg_long.png
  AssetGenImage get bgLong => const AssetGenImage('assets/images2/bg_long.png');

  /// File path: assets/images2/bg_pattern.png
  AssetGenImage get bgPattern =>
      const AssetGenImage('assets/images2/bg_pattern.png');

  /// File path: assets/images2/bg_pattern_overlay_texture.png
  AssetGenImage get bgPatternOverlayTexture =>
      const AssetGenImage('assets/images2/bg_pattern_overlay_texture.png');

  /// File path: assets/images2/bg_secure_wallet.png
  AssetGenImage get bgSecureWallet =>
      const AssetGenImage('assets/images2/bg_secure_wallet.png');
  ...
  /// File path: assets/images2/passwordbook.png
  AssetGenImage get passwordbook =>
      const AssetGenImage('assets/images2/passwordbook.png');
...
class Assets {
  ...
  static const AssetGenImage qRPlaceholder = AssetGenImage(
  ...
  static const AssetGenImage customLocation = AssetGenImage(
    'assets/custom_location.png',
  );
  static const String edit = 'assets/edit.svg';
  static const AssetGenImage encryptedVault = AssetGenImage(
    'assets/encrypted_vault.png',
  );
  static const AssetGenImage googleDrive = AssetGenImage(
  ...
  static const AssetGenImage physicalBackup = AssetGenImage(
