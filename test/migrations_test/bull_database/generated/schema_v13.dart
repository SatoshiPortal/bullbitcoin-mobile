...
class PosProfiles extends Table with TableInfo<PosProfiles, PosProfilesData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  PosProfiles(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> merchantPubkey = GeneratedColumn<String>(
    'merchant_pubkey',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  late final GeneratedColumn<String> recoveryPubkey = GeneratedColumn<String>(
    'recovery_pubkey',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'pos_profiles';
  @override
  Set<GeneratedColumn> get $primaryKey => {merchantPubkey, posId};
  @override
  PosProfilesData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return PosProfilesData(
      merchantPubkey: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}merchant_pubkey'],
      )!,
      ...
      recoveryPubkey: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}recovery_pubkey'],
      )!,
  ...
  @override
  PosProfiles createAlias(String alias) {
    return PosProfiles(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const [
    'PRIMARY KEY(merchant_pubkey, pos_id)',
  ];
  @override
  bool get dontWriteConstraints => true;
}

class PosProfilesData extends DataClass implements Insertable<PosProfilesData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['merchant_pubkey'] = Variable<String>(merchantPubkey);
    map['pos_id'] = Variable<String>(posId);
    map['wallet_id'] = Variable<String>(walletId);
    map['master_fingerprint'] = Variable<String>(masterFingerprint);
    map['recovery_pubkey'] = Variable<String>(recoveryPubkey);
  ...
  PosProfilesCompanion toCompanion(bool nullToAbsent) {
    return PosProfilesCompanion(
      merchantPubkey: Value(merchantPubkey),
      posId: Value(posId),
      walletId: Value(walletId),
      masterFingerprint: Value(masterFingerprint),
      recoveryPubkey: Value(recoveryPubkey),
  ...
  factory PosProfilesData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return PosProfilesData(
      merchantPubkey: serializer.fromJson<String>(json['merchantPubkey']),
      posId: serializer.fromJson<String>(json['posId']),
      walletId: serializer.fromJson<String>(json['walletId']),
      masterFingerprint: serializer.fromJson<String>(json['masterFingerprint']),
      recoveryPubkey: serializer.fromJson<String>(json['recoveryPubkey']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return <String, dynamic>{
      'merchantPubkey': serializer.toJson<String>(merchantPubkey),
      'posId': serializer.toJson<String>(posId),
      'walletId': serializer.toJson<String>(walletId),
      'masterFingerprint': serializer.toJson<String>(masterFingerprint),
      'recoveryPubkey': serializer.toJson<String>(recoveryPubkey),
  ...
  PosProfilesData copyWith({
    ...
    merchantPubkey: merchantPubkey ?? this.merchantPubkey,
    posId: posId ?? this.posId,
    walletId: walletId ?? this.walletId,
    masterFingerprint: masterFingerprint ?? this.masterFingerprint,
    recoveryPubkey: recoveryPubkey ?? this.recoveryPubkey,
  ...
  PosProfilesData copyWithCompanion(PosProfilesCompanion data) {
    return PosProfilesData(
      merchantPubkey: data.merchantPubkey.present
          ? data.merchantPubkey.value
          : this.merchantPubkey,
      ...
      masterFingerprint: data.masterFingerprint.present
          ? data.masterFingerprint.value
          : this.masterFingerprint,
      recoveryPubkey: data.recoveryPubkey.present
          ? data.recoveryPubkey.value
          : this.recoveryPubkey,
  ...
  @override
  String toString() {
    return (StringBuffer('PosProfilesData(')
          ..write('merchantPubkey: $merchantPubkey, ')
          ..write('posId: $posId, ')
          ..write('walletId: $walletId, ')
          ..write('masterFingerprint: $masterFingerprint, ')
          ..write('recoveryPubkey: $recoveryPubkey, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is PosProfilesData &&
          other.merchantPubkey == this.merchantPubkey &&
          other.posId == this.posId &&
          other.walletId == this.walletId &&
          other.masterFingerprint == this.masterFingerprint &&
          other.recoveryPubkey == this.recoveryPubkey &&
...
class PosProfilesCompanion extends UpdateCompanion<PosProfilesData> {
  final Value<String> merchantPubkey;
  final Value<String> posId;
  final Value<String> walletId;
  final Value<String> masterFingerprint;
  final Value<String> recoveryPubkey;
  ...
  final Value<int> createdAt;
  final Value<int> rowid;
  const PosProfilesCompanion({
    this.merchantPubkey = const Value.absent(),
    this.posId = const Value.absent(),
    this.walletId = const Value.absent(),
    this.masterFingerprint = const Value.absent(),
    this.recoveryPubkey = const Value.absent(),
  ...
  PosProfilesCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       currency = Value(currency),
       createdAt = Value(createdAt);
  static Insertable<PosProfilesData> custom({
    Expression<String>? merchantPubkey,
    Expression<String>? posId,
    Expression<String>? walletId,
    Expression<String>? masterFingerprint,
    Expression<String>? recoveryPubkey,
    ...
    return RawValuesInsertable({
      if (merchantPubkey != null) 'merchant_pubkey': merchantPubkey,
      if (posId != null) 'pos_id': posId,
      if (walletId != null) 'wallet_id': walletId,
      if (masterFingerprint != null) 'master_fingerprint': masterFingerprint,
      if (recoveryPubkey != null) 'recovery_pubkey': recoveryPubkey,
  ...
  PosProfilesCompanion copyWith({
    Value<String>? merchantPubkey,
    Value<String>? posId,
    Value<String>? walletId,
    Value<String>? masterFingerprint,
    Value<String>? recoveryPubkey,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    if (merchantPubkey.present) {
      map['merchant_pubkey'] = Variable<String>(merchantPubkey.value);
    }
    if (posId.present) {
    ...
    if (recoveryPubkey.present) {
      map['recovery_pubkey'] = Variable<String>(recoveryPubkey.value);
    }
  ...
  @override
  String toString() {
    return (StringBuffer('PosProfilesCompanion(')
          ..write('merchantPubkey: $merchantPubkey, ')
          ..write('posId: $posId, ')
          ..write('walletId: $walletId, ')
          ..write('masterFingerprint: $masterFingerprint, ')
...
class PosAuthorizedTerminals extends Table
    with TableInfo<PosAuthorizedTerminals, PosAuthorizedTerminalsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  PosAuthorizedTerminals(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> merchantPubkey = GeneratedColumn<String>(
    'merchant_pubkey',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<String> terminalPubkey = GeneratedColumn<String>(
    'terminal_pubkey',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  late final GeneratedColumn<String> ctDescriptorRef = GeneratedColumn<String>(
    'ct_descriptor_ref',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  late final GeneratedColumn<String> saleBucketSecretRef =
      GeneratedColumn<String>(
        'sale_bucket_secret_ref',
        aliasedName,
        false,
        type: DriftSqlType.string,
        requiredDuringInsert: true,
  ...
  late final GeneratedColumn<int> saleBucketGeneration = GeneratedColumn<int>(
    'sale_bucket_generation',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: true,
  ...
  late final GeneratedColumn<int> effectiveFromEpochDay = GeneratedColumn<int>(
  ...
  late final GeneratedColumn<int> terminalIndex = GeneratedColumn<int>(
    'terminal_index',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  late final GeneratedColumn<int> authorizedAt = GeneratedColumn<int>(
    'authorized_at',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'pos_authorized_terminals';
  @override
  ...
  @override
  PosAuthorizedTerminalsData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return PosAuthorizedTerminalsData(
      merchantPubkey: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}merchant_pubkey'],
      )!,
      ...
      terminalPubkey: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}terminal_pubkey'],
      )!,
      terminalId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}terminal_id'],
      )!,
      ctDescriptorRef: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}ct_descriptor_ref'],
      )!,
      saleBucketSecretRef: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}sale_bucket_secret_ref'],
      )!,
      saleBucketGeneration: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}sale_bucket_generation'],
      )!,
      effectiveFromEpochDay: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}effective_from_epoch_day'],
      )!,
      terminalIndex: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}terminal_index'],
      )!,
  ...
  @override
  PosAuthorizedTerminals createAlias(String alias) {
    return PosAuthorizedTerminals(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const [
    'PRIMARY KEY(merchant_pubkey, pos_id, terminal_pubkey)',
  ];
  @override
  bool get dontWriteConstraints => true;
}

class PosAuthorizedTerminalsData extends DataClass
    implements Insertable<PosAuthorizedTerminalsData> {
  final String merchantPubkey;
  final String posId;
  ...
  final int? revokedAt;
  const PosAuthorizedTerminalsData({
    required this.merchantPubkey,
    required this.posId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['merchant_pubkey'] = Variable<String>(merchantPubkey);
    map['pos_id'] = Variable<String>(posId);
    map['terminal_pubkey'] = Variable<String>(terminalPubkey);
    map['terminal_id'] = Variable<String>(terminalId);
    map['ct_descriptor_ref'] = Variable<String>(ctDescriptorRef);
    map['sale_bucket_secret_ref'] = Variable<String>(saleBucketSecretRef);
    map['sale_bucket_generation'] = Variable<int>(saleBucketGeneration);
    map['effective_from_epoch_day'] = Variable<int>(effectiveFromEpochDay);
    map['terminal_index'] = Variable<int>(terminalIndex);
    map['authorized_at'] = Variable<int>(authorizedAt);
  ...
  PosAuthorizedTerminalsCompanion toCompanion(bool nullToAbsent) {
    return PosAuthorizedTerminalsCompanion(
      merchantPubkey: Value(merchantPubkey),
      posId: Value(posId),
      terminalPubkey: Value(terminalPubkey),
      terminalId: Value(terminalId),
      ctDescriptorRef: Value(ctDescriptorRef),
      saleBucketSecretRef: Value(saleBucketSecretRef),
      saleBucketGeneration: Value(saleBucketGeneration),
      effectiveFromEpochDay: Value(effectiveFromEpochDay),
  ...
  factory PosAuthorizedTerminalsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return PosAuthorizedTerminalsData(
      merchantPubkey: serializer.fromJson<String>(json['merchantPubkey']),
      posId: serializer.fromJson<String>(json['posId']),
      terminalPubkey: serializer.fromJson<String>(json['terminalPubkey']),
      terminalId: serializer.fromJson<String>(json['terminalId']),
      ctDescriptorRef: serializer.fromJson<String>(json['ctDescriptorRef']),
      saleBucketSecretRef: serializer.fromJson<String>(
        json['saleBucketSecretRef'],
      ),
      saleBucketGeneration: serializer.fromJson<int>(
        json['saleBucketGeneration'],
      ),
      effectiveFromEpochDay: serializer.fromJson<int>(
        json['effectiveFromEpochDay'],
      ),
      terminalIndex: serializer.fromJson<int>(json['terminalIndex']),
      authorizedAt: serializer.fromJson<int>(json['authorizedAt']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'merchantPubkey': serializer.toJson<String>(merchantPubkey),
      'posId': serializer.toJson<String>(posId),
      'terminalPubkey': serializer.toJson<String>(terminalPubkey),
      'terminalId': serializer.toJson<String>(terminalId),
      'ctDescriptorRef': serializer.toJson<String>(ctDescriptorRef),
      'saleBucketSecretRef': serializer.toJson<String>(saleBucketSecretRef),
      'saleBucketGeneration': serializer.toJson<int>(saleBucketGeneration),
      'effectiveFromEpochDay': serializer.toJson<int>(effectiveFromEpochDay),
      'terminalIndex': serializer.toJson<int>(terminalIndex),
      'authorizedAt': serializer.toJson<int>(authorizedAt),
      'revokedAt': serializer.toJson<int?>(revokedAt),
    };
  }

  PosAuthorizedTerminalsData copyWith({
    String? merchantPubkey,
    String? posId,
    String? terminalPubkey,
    String? terminalId,
    String? ctDescriptorRef,
    String? saleBucketSecretRef,
    int? saleBucketGeneration,
    int? effectiveFromEpochDay,
    int? terminalIndex,
    int? authorizedAt,
    Value<int?> revokedAt = const Value.absent(),
  }) => PosAuthorizedTerminalsData(
    merchantPubkey: merchantPubkey ?? this.merchantPubkey,
    posId: posId ?? this.posId,
    terminalPubkey: terminalPubkey ?? this.terminalPubkey,
    terminalId: terminalId ?? this.terminalId,
    ctDescriptorRef: ctDescriptorRef ?? this.ctDescriptorRef,
    saleBucketSecretRef: saleBucketSecretRef ?? this.saleBucketSecretRef,
    saleBucketGeneration: saleBucketGeneration ?? this.saleBucketGeneration,
    effectiveFromEpochDay: effectiveFromEpochDay ?? this.effectiveFromEpochDay,
    terminalIndex: terminalIndex ?? this.terminalIndex,
    authorizedAt: authorizedAt ?? this.authorizedAt,
    revokedAt: revokedAt.present ? revokedAt.value : this.revokedAt,
  );
  PosAuthorizedTerminalsData copyWithCompanion(
    PosAuthorizedTerminalsCompanion data,
  ) {
    return PosAuthorizedTerminalsData(
      merchantPubkey: data.merchantPubkey.present
          ? data.merchantPubkey.value
          : this.merchantPubkey,
      posId: data.posId.present ? data.posId.value : this.posId,
      terminalPubkey: data.terminalPubkey.present
          ? data.terminalPubkey.value
          : this.terminalPubkey,
      terminalId: data.terminalId.present
          ? data.terminalId.value
          : this.terminalId,
      ctDescriptorRef: data.ctDescriptorRef.present
          ? data.ctDescriptorRef.value
          : this.ctDescriptorRef,
      saleBucketSecretRef: data.saleBucketSecretRef.present
          ? data.saleBucketSecretRef.value
          : this.saleBucketSecretRef,
      saleBucketGeneration: data.saleBucketGeneration.present
          ? data.saleBucketGeneration.value
          : this.saleBucketGeneration,
      effectiveFromEpochDay: data.effectiveFromEpochDay.present
          ? data.effectiveFromEpochDay.value
          : this.effectiveFromEpochDay,
      terminalIndex: data.terminalIndex.present
          ? data.terminalIndex.value
          : this.terminalIndex,
  ...
  @override
  String toString() {
    return (StringBuffer('PosAuthorizedTerminalsData(')
          ..write('merchantPubkey: $merchantPubkey, ')
          ..write('posId: $posId, ')
          ..write('terminalPubkey: $terminalPubkey, ')
          ..write('terminalId: $terminalId, ')
          ..write('ctDescriptorRef: $ctDescriptorRef, ')
          ..write('saleBucketSecretRef: $saleBucketSecretRef, ')
          ..write('saleBucketGeneration: $saleBucketGeneration, ')
          ..write('effectiveFromEpochDay: $effectiveFromEpochDay, ')
          ..write('terminalIndex: $terminalIndex, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is PosAuthorizedTerminalsData &&
          other.merchantPubkey == this.merchantPubkey &&
          other.posId == this.posId &&
          other.terminalPubkey == this.terminalPubkey &&
          other.terminalId == this.terminalId &&
          other.ctDescriptorRef == this.ctDescriptorRef &&
          other.saleBucketSecretRef == this.saleBucketSecretRef &&
          other.saleBucketGeneration == this.saleBucketGeneration &&
          other.effectiveFromEpochDay == this.effectiveFromEpochDay &&
          other.terminalIndex == this.terminalIndex &&
          other.authorizedAt == this.authorizedAt &&
          other.revokedAt == this.revokedAt);
}

class PosAuthorizedTerminalsCompanion
    extends UpdateCompanion<PosAuthorizedTerminalsData> {
  final Value<String> merchantPubkey;
  final Value<String> posId;
  final Value<String> terminalPubkey;
  final Value<String> terminalId;
  final Value<String> ctDescriptorRef;
  final Value<String> saleBucketSecretRef;
  final Value<int> saleBucketGeneration;
  final Value<int> effectiveFromEpochDay;
  final Value<int> terminalIndex;
  final Value<int> authorizedAt;
  final Value<int?> revokedAt;
  final Value<int> rowid;
  const PosAuthorizedTerminalsCompanion({
    this.merchantPubkey = const Value.absent(),
    this.posId = const Value.absent(),
    this.terminalPubkey = const Value.absent(),
    this.terminalId = const Value.absent(),
    this.ctDescriptorRef = const Value.absent(),
    this.saleBucketSecretRef = const Value.absent(),
    this.saleBucketGeneration = const Value.absent(),
    this.effectiveFromEpochDay = const Value.absent(),
    this.terminalIndex = const Value.absent(),
    this.authorizedAt = const Value.absent(),
    this.revokedAt = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  PosAuthorizedTerminalsCompanion.insert({
    required String merchantPubkey,
    required String posId,
    required String terminalPubkey,
    required String terminalId,
    required String ctDescriptorRef,
    required String saleBucketSecretRef,
    required int saleBucketGeneration,
    required int effectiveFromEpochDay,
    required int terminalIndex,
    required int authorizedAt,
    this.revokedAt = const Value.absent(),
    this.rowid = const Value.absent(),
  }) : merchantPubkey = Value(merchantPubkey),
       posId = Value(posId),
       ...
       terminalIndex = Value(terminalIndex),
       authorizedAt = Value(authorizedAt);
  static Insertable<PosAuthorizedTerminalsData> custom({
    Expression<String>? merchantPubkey,
    Expression<String>? posId,
    Expression<String>? terminalPubkey,
    Expression<String>? terminalId,
    Expression<String>? ctDescriptorRef,
    Expression<String>? saleBucketSecretRef,
    Expression<int>? saleBucketGeneration,
    Expression<int>? effectiveFromEpochDay,
    Expression<int>? terminalIndex,
    Expression<int>? authorizedAt,
    ...
    return RawValuesInsertable({
      if (merchantPubkey != null) 'merchant_pubkey': merchantPubkey,
      if (posId != null) 'pos_id': posId,
      if (terminalPubkey != null) 'terminal_pubkey': terminalPubkey,
      if (terminalId != null) 'terminal_id': terminalId,
      if (ctDescriptorRef != null) 'ct_descriptor_ref': ctDescriptorRef,
      if (saleBucketSecretRef != null)
        'sale_bucket_secret_ref': saleBucketSecretRef,
      if (saleBucketGeneration != null)
        'sale_bucket_generation': saleBucketGeneration,
      if (effectiveFromEpochDay != null)
        'effective_from_epoch_day': effectiveFromEpochDay,
      if (terminalIndex != null) 'terminal_index': terminalIndex,
  ...
  PosAuthorizedTerminalsCompanion copyWith({
    Value<String>? merchantPubkey,
    Value<String>? posId,
    Value<String>? terminalPubkey,
    Value<String>? terminalId,
    Value<String>? ctDescriptorRef,
    Value<String>? saleBucketSecretRef,
    Value<int>? saleBucketGeneration,
    Value<int>? effectiveFromEpochDay,
    Value<int>? terminalIndex,
    Value<int>? authorizedAt,
    Value<int?>? revokedAt,
    Value<int>? rowid,
  }) {
    return PosAuthorizedTerminalsCompanion(
      ...
      saleBucketGeneration: saleBucketGeneration ?? this.saleBucketGeneration,
      effectiveFromEpochDay:
          effectiveFromEpochDay ?? this.effectiveFromEpochDay,
      terminalIndex: terminalIndex ?? this.terminalIndex,
      authorizedAt: authorizedAt ?? this.authorizedAt,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (terminalPubkey.present) {
      map['terminal_pubkey'] = Variable<String>(terminalPubkey.value);
    }
    if (terminalId.present) {
      map['terminal_id'] = Variable<String>(terminalId.value);
    }
    if (ctDescriptorRef.present) {
      map['ct_descriptor_ref'] = Variable<String>(ctDescriptorRef.value);
    }
    if (saleBucketSecretRef.present) {
      map['sale_bucket_secret_ref'] = Variable<String>(
        saleBucketSecretRef.value,
      );
    }
    if (saleBucketGeneration.present) {
      map['sale_bucket_generation'] = Variable<int>(saleBucketGeneration.value);
    }
    if (effectiveFromEpochDay.present) {
      map['effective_from_epoch_day'] = Variable<int>(
        effectiveFromEpochDay.value,
      );
    }
    if (terminalIndex.present) {
      map['terminal_index'] = Variable<int>(terminalIndex.value);
    }
    if (authorizedAt.present) {
      map['authorized_at'] = Variable<int>(authorizedAt.value);
    }
  ...
  @override
  String toString() {
    return (StringBuffer('PosAuthorizedTerminalsCompanion(')
          ..write('merchantPubkey: $merchantPubkey, ')
          ..write('posId: $posId, ')
          ..write('terminalPubkey: $terminalPubkey, ')
          ..write('terminalId: $terminalId, ')
...
class PosObservedEvents extends Table
    with TableInfo<PosObservedEvents, PosObservedEventsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  PosObservedEvents(this.attachedDatabase, [this._alias]);
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'pos_observed_events';
  @override
  Set<GeneratedColumn> get $primaryKey => {eventId};
  @override
  PosObservedEventsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return PosObservedEventsData(
  ...
  @override
  PosObservedEvents createAlias(String alias) {
    return PosObservedEvents(attachedDatabase, alias);
  }
...
class PosObservedEventsData extends DataClass
    implements Insertable<PosObservedEventsData> {
  ...
  PosObservedEventsCompanion toCompanion(bool nullToAbsent) {
    return PosObservedEventsCompanion(
  ...
  factory PosObservedEventsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  PosObservedEventsData copyWith({
    String? eventId,
    int? kind,
    String? pubkey,
    int? createdAt,
  ...
  PosObservedEventsData copyWithCompanion(PosObservedEventsCompanion data) {
    return PosObservedEventsData(
  ...
  @override
  String toString() {
    return (StringBuffer('PosObservedEventsData(')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is PosObservedEventsData &&
...
class PosObservedEventsCompanion
    extends UpdateCompanion<PosObservedEventsData> {
  ...
  final Value<int> rowid;
  const PosObservedEventsCompanion({
  ...
  PosObservedEventsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       posId = Value(posId),
       rawJson = Value(rawJson);
  static Insertable<PosObservedEventsData> custom({
  ...
  PosObservedEventsCompanion copyWith({
  ...
  @override
  String toString() {
    return (StringBuffer('PosObservedEventsCompanion(')
          ..write('eventId: $eventId, ')
          ..write('kind: $kind, ')
          ..write('pubkey: $pubkey, ')
          ..write('createdAt: $createdAt, ')
...
class DatabaseAtV13 extends GeneratedDatabase {
  ...
  late final PosProfiles posProfiles = PosProfiles(this);
  late final PosAuthorizedTerminals posAuthorizedTerminals =
      PosAuthorizedTerminals(this);
  late final PosObservedEvents posObservedEvents = PosObservedEvents(this);
  @override
