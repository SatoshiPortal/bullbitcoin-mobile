...
class WalletMetadatas extends Table
  ...
  late final GeneratedColumn<String> bitcoinSyncBackend =
      GeneratedColumn<String>(
        'bitcoin_sync_backend',
        aliasedName,
        false,
        type: DriftSqlType.string,
        requiredDuringInsert: false,
        $customConstraints: 'NOT NULL DEFAULT \'electrum\'',
        defaultValue: const CustomExpression('\'electrum\''),
      );
  late final GeneratedColumn<int> lastReceiveAddressIndex =
      GeneratedColumn<int>(
        'last_receive_address_index',
        aliasedName,
        false,
        type: DriftSqlType.int,
        requiredDuringInsert: false,
  ...
  late final GeneratedColumn<String> birthdayBlockTimestamp =
      GeneratedColumn<String>(
  ...
  late final GeneratedColumn<int> birthdayBlockHeight = GeneratedColumn<int>(
  ...
  late final GeneratedColumn<String> birthdayBlockHash =
      GeneratedColumn<String>(
        'birthday_block_hash',
        aliasedName,
        true,
  ...
  List<GeneratedColumn> get $columns => [
    ...
    birthday,
    bitcoinSyncBackend,
    lastReceiveAddressIndex,
    birthdayBlockTimestamp,
    birthdayBlockHeight,
    birthdayBlockHash,
  ];
  @override
  ...
  WalletMetadatasData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return WalletMetadatasData(
      ...
      bitcoinSyncBackend: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}bitcoin_sync_backend'],
      )!,
      lastReceiveAddressIndex: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}last_receive_address_index'],
      )!,
      birthdayBlockTimestamp: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}birthday_block_timestamp'],
      ),
      birthdayBlockHeight: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}birthday_block_height'],
      ),
      birthdayBlockHash: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}birthday_block_hash'],
      ),
    );
  }
...
class WalletMetadatasData extends DataClass
  ...
  final String bitcoinSyncBackend;
  final int lastReceiveAddressIndex;
  final String? birthdayBlockTimestamp;
  final int? birthdayBlockHeight;
  final String? birthdayBlockHash;
  const WalletMetadatasData({
    ...
    this.syncedAt,
    this.birthday,
    required this.bitcoinSyncBackend,
    required this.lastReceiveAddressIndex,
    this.birthdayBlockTimestamp,
    this.birthdayBlockHeight,
    this.birthdayBlockHash,
  });
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    ...
    map['bitcoin_sync_backend'] = Variable<String>(bitcoinSyncBackend);
    map['last_receive_address_index'] = Variable<int>(lastReceiveAddressIndex);
    if (!nullToAbsent || birthdayBlockTimestamp != null) {
      map['birthday_block_timestamp'] = Variable<String>(
        birthdayBlockTimestamp,
      );
    }
    if (!nullToAbsent || birthdayBlockHeight != null) {
      map['birthday_block_height'] = Variable<int>(birthdayBlockHeight);
    }
    if (!nullToAbsent || birthdayBlockHash != null) {
      map['birthday_block_hash'] = Variable<String>(birthdayBlockHash);
    }
    return map;
  }
  ...
  WalletMetadatasCompanion toCompanion(bool nullToAbsent) {
    return WalletMetadatasCompanion(
      ...
      birthdayBlockTimestamp: birthdayBlockTimestamp == null && nullToAbsent
          ? const Value.absent()
          : Value(birthdayBlockTimestamp),
      birthdayBlockHeight: birthdayBlockHeight == null && nullToAbsent
          ? const Value.absent()
          : Value(birthdayBlockHeight),
      birthdayBlockHash: birthdayBlockHash == null && nullToAbsent
          ? const Value.absent()
          : Value(birthdayBlockHash),
    );
  }
  ...
  factory WalletMetadatasData.fromJson(
    ...
    return WalletMetadatasData(
      ...
      bitcoinSyncBackend: serializer.fromJson<String>(
        json['bitcoinSyncBackend'],
      ),
      lastReceiveAddressIndex: serializer.fromJson<int>(
        json['lastReceiveAddressIndex'],
      ),
      birthdayBlockTimestamp: serializer.fromJson<String?>(
        json['birthdayBlockTimestamp'],
      ),
      birthdayBlockHeight: serializer.fromJson<int?>(
        json['birthdayBlockHeight'],
      ),
      birthdayBlockHash: serializer.fromJson<String?>(
        json['birthdayBlockHash'],
      ),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'bitcoinSyncBackend': serializer.toJson<String>(bitcoinSyncBackend),
      'lastReceiveAddressIndex': serializer.toJson<int>(
        lastReceiveAddressIndex,
      ),
      'birthdayBlockTimestamp': serializer.toJson<String?>(
        birthdayBlockTimestamp,
      ),
      'birthdayBlockHeight': serializer.toJson<int?>(birthdayBlockHeight),
      'birthdayBlockHash': serializer.toJson<String?>(birthdayBlockHash),
    };
  }
  ...
  WalletMetadatasData copyWith({
    ...
    String? bitcoinSyncBackend,
    int? lastReceiveAddressIndex,
    Value<String?> birthdayBlockTimestamp = const Value.absent(),
    Value<int?> birthdayBlockHeight = const Value.absent(),
    Value<String?> birthdayBlockHash = const Value.absent(),
  }) => WalletMetadatasData(
    id: id ?? this.id,
    ...
    bitcoinSyncBackend: bitcoinSyncBackend ?? this.bitcoinSyncBackend,
    lastReceiveAddressIndex:
        lastReceiveAddressIndex ?? this.lastReceiveAddressIndex,
    birthdayBlockTimestamp: birthdayBlockTimestamp.present
        ? birthdayBlockTimestamp.value
        : this.birthdayBlockTimestamp,
    birthdayBlockHeight: birthdayBlockHeight.present
        ? birthdayBlockHeight.value
        : this.birthdayBlockHeight,
    birthdayBlockHash: birthdayBlockHash.present
        ? birthdayBlockHash.value
        : this.birthdayBlockHash,
  );
  WalletMetadatasData copyWithCompanion(WalletMetadatasCompanion data) {
    return WalletMetadatasData(
      ...
      bitcoinSyncBackend: data.bitcoinSyncBackend.present
          ? data.bitcoinSyncBackend.value
          : this.bitcoinSyncBackend,
      lastReceiveAddressIndex: data.lastReceiveAddressIndex.present
          ? data.lastReceiveAddressIndex.value
          : this.lastReceiveAddressIndex,
      birthdayBlockTimestamp: data.birthdayBlockTimestamp.present
          ? data.birthdayBlockTimestamp.value
          : this.birthdayBlockTimestamp,
      birthdayBlockHeight: data.birthdayBlockHeight.present
          ? data.birthdayBlockHeight.value
          : this.birthdayBlockHeight,
      birthdayBlockHash: data.birthdayBlockHash.present
          ? data.birthdayBlockHash.value
          : this.birthdayBlockHash,
    );
  }
  ...
  String toString() {
    return (StringBuffer('WalletMetadatasData(')
          ...
          ..write('bitcoinSyncBackend: $bitcoinSyncBackend, ')
          ..write('lastReceiveAddressIndex: $lastReceiveAddressIndex, ')
          ..write('birthdayBlockTimestamp: $birthdayBlockTimestamp, ')
          ..write('birthdayBlockHeight: $birthdayBlockHeight, ')
          ..write('birthdayBlockHash: $birthdayBlockHash')
          ..write(')'))
        .toString();
  }
  ...
  bool operator ==(Object other) =>
      ...
      (other is WalletMetadatasData &&
          ...
          other.bitcoinSyncBackend == this.bitcoinSyncBackend &&
          other.lastReceiveAddressIndex == this.lastReceiveAddressIndex &&
          other.birthdayBlockTimestamp == this.birthdayBlockTimestamp &&
          other.birthdayBlockHeight == this.birthdayBlockHeight &&
          other.birthdayBlockHash == this.birthdayBlockHash);
}
...
class WalletMetadatasCompanion extends UpdateCompanion<WalletMetadatasData> {
  ...
  final Value<String> bitcoinSyncBackend;
  final Value<int> lastReceiveAddressIndex;
  final Value<String?> birthdayBlockTimestamp;
  final Value<int?> birthdayBlockHeight;
  final Value<String?> birthdayBlockHash;
  final Value<int> rowid;
  const WalletMetadatasCompanion({
    ...
    this.bitcoinSyncBackend = const Value.absent(),
    this.lastReceiveAddressIndex = const Value.absent(),
    this.birthdayBlockTimestamp = const Value.absent(),
    this.birthdayBlockHeight = const Value.absent(),
    this.birthdayBlockHash = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  ...
  static Insertable<WalletMetadatasData> custom({
    ...
    Expression<String>? bitcoinSyncBackend,
    Expression<int>? lastReceiveAddressIndex,
    Expression<String>? birthdayBlockTimestamp,
    Expression<int>? birthdayBlockHeight,
    Expression<String>? birthdayBlockHash,
    Expression<int>? rowid,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
      ...
      if (bitcoinSyncBackend != null)
        'bitcoin_sync_backend': bitcoinSyncBackend,
      if (lastReceiveAddressIndex != null)
        'last_receive_address_index': lastReceiveAddressIndex,
      if (birthdayBlockTimestamp != null)
        'birthday_block_timestamp': birthdayBlockTimestamp,
      if (birthdayBlockHeight != null)
        'birthday_block_height': birthdayBlockHeight,
      if (birthdayBlockHash != null) 'birthday_block_hash': birthdayBlockHash,
      if (rowid != null) 'rowid': rowid,
    });
  }
  ...
  WalletMetadatasCompanion copyWith({
    ...
    Value<String>? bitcoinSyncBackend,
    Value<int>? lastReceiveAddressIndex,
    Value<String?>? birthdayBlockTimestamp,
    Value<int?>? birthdayBlockHeight,
    Value<String?>? birthdayBlockHash,
    Value<int>? rowid,
  }) {
    return WalletMetadatasCompanion(
      id: id ?? this.id,
      ...
      lastReceiveAddressIndex:
          lastReceiveAddressIndex ?? this.lastReceiveAddressIndex,
      birthdayBlockTimestamp:
          birthdayBlockTimestamp ?? this.birthdayBlockTimestamp,
      birthdayBlockHeight: birthdayBlockHeight ?? this.birthdayBlockHeight,
      birthdayBlockHash: birthdayBlockHash ?? this.birthdayBlockHash,
      rowid: rowid ?? this.rowid,
    );
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (bitcoinSyncBackend.present) {
      map['bitcoin_sync_backend'] = Variable<String>(bitcoinSyncBackend.value);
    }
    if (lastReceiveAddressIndex.present) {
      map['last_receive_address_index'] = Variable<int>(
        lastReceiveAddressIndex.value,
      );
    }
    if (birthdayBlockTimestamp.present) {
      map['birthday_block_timestamp'] = Variable<String>(
        birthdayBlockTimestamp.value,
      );
    }
    if (birthdayBlockHeight.present) {
      map['birthday_block_height'] = Variable<int>(birthdayBlockHeight.value);
    }
    if (birthdayBlockHash.present) {
      map['birthday_block_hash'] = Variable<String>(birthdayBlockHash.value);
    }
    if (rowid.present) {
      map['rowid'] = Variable<int>(rowid.value);
    }
...
class Settings extends Table with TableInfo<Settings, SettingsData> {
  ...
  useCompactBlockFiltersByDefault = GeneratedColumn<int>(
    'use_compact_block_filters_by_default',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints:
        'NOT NULL DEFAULT 0 CHECK (use_compact_block_filters_by_default IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
  @override
  List<GeneratedColumn> get $columns => [
    ...
    useCompactBlockFiltersByDefault,
  ];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  ...
  SettingsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return SettingsData(
      ...
      useCompactBlockFiltersByDefault: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}use_compact_block_filters_by_default'],
      )!,
    );
  }
...
class SettingsData extends DataClass implements Insertable<SettingsData> {
  ...
  final int useCompactBlockFiltersByDefault;
  const SettingsData({
    required this.id,
    ...
    required this.useCompactBlockFiltersByDefault,
  });
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    ...
    map['use_compact_block_filters_by_default'] = Variable<int>(
      useCompactBlockFiltersByDefault,
    );
    return map;
  }
  ...
  SettingsCompanion toCompanion(bool nullToAbsent) {
    return SettingsCompanion(
      ...
      useCompactBlockFiltersByDefault: Value(useCompactBlockFiltersByDefault),
    );
  }
  ...
  factory SettingsData.fromJson(
    ...
    return SettingsData(
      ...
      useCompactBlockFiltersByDefault: serializer.fromJson<int>(
        json['useCompactBlockFiltersByDefault'],
      ),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'useCompactBlockFiltersByDefault': serializer.toJson<int>(
        useCompactBlockFiltersByDefault,
      ),
    };
  }
  ...
  SettingsData copyWith({
    ...
    int? useCompactBlockFiltersByDefault,
  }) => SettingsData(
    id: id ?? this.id,
    ...
    exchangeTestnetBasicAuthPassword: exchangeTestnetBasicAuthPassword.present
        ...
        : this.exchangeTestnetBasicAuthPassword,
    useCompactBlockFiltersByDefault:
        useCompactBlockFiltersByDefault ?? this.useCompactBlockFiltersByDefault,
  );
  SettingsData copyWithCompanion(SettingsCompanion data) {
    return SettingsData(
      ...
      exchangeTestnetBasicAuthPassword:
          ...
          : this.exchangeTestnetBasicAuthPassword,
      useCompactBlockFiltersByDefault:
          data.useCompactBlockFiltersByDefault.present
          ? data.useCompactBlockFiltersByDefault.value
          : this.useCompactBlockFiltersByDefault,
    );
  }
  ...
  bool operator ==(Object other) =>
      ...
      (other is SettingsData &&
          ...
          other.exchangeTestnetBasicAuthPassword ==
              this.exchangeTestnetBasicAuthPassword &&
          other.useCompactBlockFiltersByDefault ==
              this.useCompactBlockFiltersByDefault);
}
...
class SettingsCompanion extends UpdateCompanion<SettingsData> {
  ...
  final Value<int> useCompactBlockFiltersByDefault;
  const SettingsCompanion({
    ...
    this.useCompactBlockFiltersByDefault = const Value.absent(),
  });
  ...
  static Insertable<SettingsData> custom({
    ...
    Expression<int>? useCompactBlockFiltersByDefault,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
      ...
      if (exchangeTestnetBasicAuthPassword != null)
        'exchange_testnet_basic_auth_password':
            exchangeTestnetBasicAuthPassword,
      if (useCompactBlockFiltersByDefault != null)
        'use_compact_block_filters_by_default': useCompactBlockFiltersByDefault,
    });
  }
  ...
  SettingsCompanion copyWith({
    ...
    Value<int>? useCompactBlockFiltersByDefault,
  }) {
    return SettingsCompanion(
      id: id ?? this.id,
      environment: environment ?? this.environment,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (useCompactBlockFiltersByDefault.present) {
      map['use_compact_block_filters_by_default'] = Variable<int>(
        useCompactBlockFiltersByDefault.value,
      );
    }
    return map;
  }
