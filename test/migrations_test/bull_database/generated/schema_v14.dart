...
class Settings extends Table with TableInfo<Settings, SettingsData> {
  ...
  late final GeneratedColumn<int> hideExchangeFeatures = GeneratedColumn<int>(
    'hide_exchange_features',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints:
        'NOT NULL DEFAULT 0 CHECK (hide_exchange_features IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
  @override
  List<GeneratedColumn> get $columns => [
  ...
  SettingsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return SettingsData(
      ...
      hideExchangeFeatures: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}hide_exchange_features'],
      )!,
    );
  }
...
class SettingsData extends DataClass implements Insertable<SettingsData> {
  ...
  final int hideExchangeFeatures;
  const SettingsData({
    required this.id,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['hide_exchange_features'] = Variable<int>(hideExchangeFeatures);
    return map;
  }
  ...
  SettingsCompanion toCompanion(bool nullToAbsent) {
    return SettingsCompanion(
      ...
      hideExchangeFeatures: Value(hideExchangeFeatures),
    );
  }
  ...
  factory SettingsData.fromJson(
    ...
    return SettingsData(
      ...
      hideExchangeFeatures: serializer.fromJson<int>(
        json['hideExchangeFeatures'],
      ),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'hideExchangeFeatures': serializer.toJson<int>(hideExchangeFeatures),
    };
  }
  ...
  SettingsData copyWith({
    ...
    exchangeTestnetBasicAuthPassword: exchangeTestnetBasicAuthPassword.present
        ...
        : this.exchangeTestnetBasicAuthPassword,
    hideExchangeFeatures: hideExchangeFeatures ?? this.hideExchangeFeatures,
  );
  SettingsData copyWithCompanion(SettingsCompanion data) {
    return SettingsData(
      ...
      exchangeTestnetBasicAuthPassword:
          ...
          : this.exchangeTestnetBasicAuthPassword,
      hideExchangeFeatures: data.hideExchangeFeatures.present
          ? data.hideExchangeFeatures.value
          : this.hideExchangeFeatures,
    );
  }
  ...
  String toString() {
    return (StringBuffer('SettingsData(')
          ...
          ..write('hideExchangeFeatures: $hideExchangeFeatures')
          ..write(')'))
        .toString();
  }
  ...
  bool operator ==(Object other) =>
      ...
      (other is SettingsData &&
          ...
          other.exchangeTestnetBasicAuthPassword ==
              this.exchangeTestnetBasicAuthPassword &&
          other.hideExchangeFeatures == this.hideExchangeFeatures);
}
...
class SettingsCompanion extends UpdateCompanion<SettingsData> {
  ...
  final Value<int> hideExchangeFeatures;
  const SettingsCompanion({
    ...
    this.hideExchangeFeatures = const Value.absent(),
  });
  ...
  static Insertable<SettingsData> custom({
    ...
    Expression<int>? hideExchangeFeatures,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
      ...
      if (exchangeTestnetBasicAuthPassword != null)
        'exchange_testnet_basic_auth_password':
            exchangeTestnetBasicAuthPassword,
      if (hideExchangeFeatures != null)
        'hide_exchange_features': hideExchangeFeatures,
    });
  }
  ...
  SettingsCompanion copyWith({
    ...
    Value<int>? hideExchangeFeatures,
  }) {
    return SettingsCompanion(
      id: id ?? this.id,
      environment: environment ?? this.environment,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (hideExchangeFeatures.present) {
      map['hide_exchange_features'] = Variable<int>(hideExchangeFeatures.value);
    }
    return map;
  }
