...
class KeychainManifestBackupStates extends Table
    with
        TableInfo<
          ...
          KeychainManifestBackupStatesData
        > {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  KeychainManifestBackupStates(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'keychain_manifest_backup_states';
  @override
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  KeychainManifestBackupStatesData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return KeychainManifestBackupStatesData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  KeychainManifestBackupStates createAlias(String alias) {
    return KeychainManifestBackupStates(attachedDatabase, alias);
  }
...
class KeychainManifestBackupStatesData extends DataClass
    implements Insertable<KeychainManifestBackupStatesData> {
  final int id;
  final int enabled;
  final int dirty;
  ...
  const KeychainManifestBackupStatesData({
    required this.id,
    required this.enabled,
    required this.dirty,
  ...
  KeychainManifestBackupStatesCompanion toCompanion(bool nullToAbsent) {
    return KeychainManifestBackupStatesCompanion(
      id: Value(id),
      enabled: Value(enabled),
      dirty: Value(dirty),
  ...
  factory KeychainManifestBackupStatesData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  KeychainManifestBackupStatesData copyWith({
    int? id,
    int? enabled,
    int? dirty,
    int? dirtyRevision,
  ...
  KeychainManifestBackupStatesData copyWithCompanion(
    KeychainManifestBackupStatesCompanion data,
  ) {
    return KeychainManifestBackupStatesData(
      id: data.id.present ? data.id.value : this.id,
      enabled: data.enabled.present ? data.enabled.value : this.enabled,
  ...
  @override
  String toString() {
    return (StringBuffer('KeychainManifestBackupStatesData(')
          ..write('id: $id, ')
          ..write('enabled: $enabled, ')
          ..write('dirty: $dirty, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is KeychainManifestBackupStatesData &&
          other.id == this.id &&
          other.enabled == this.enabled &&
...
class KeychainManifestBackupStatesCompanion
    extends UpdateCompanion<KeychainManifestBackupStatesData> {
  final Value<int> id;
  final Value<int> enabled;
  ...
  static Insertable<KeychainManifestBackupStatesData> custom({
    Expression<int>? id,
    Expression<int>? enabled,
  ...
  KeychainManifestBackupStatesCompanion copyWith({
    Value<int>? id,
    Value<int>? enabled,
    Value<int>? dirty,
  ...
  @override
  String toString() {
    return (StringBuffer('KeychainManifestBackupStatesCompanion(')
          ..write('id: $id, ')
          ..write('enabled: $enabled, ')
          ..write('dirty: $dirty, ')
          ..write('dirtyRevision: $dirtyRevision, ')
...
class WalletMetadataBackupStates extends Table
    with TableInfo<WalletMetadataBackupStates, WalletMetadataBackupStatesData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  WalletMetadataBackupStates(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<int> lastVerifiedSnapshotRevision =
      GeneratedColumn<int>(
  ...
  late final GeneratedColumn<String> lastVerifiedContentHash =
      GeneratedColumn<String>(
  ...
  late final GeneratedColumn<int> blockedRemoteGeneration =
      GeneratedColumn<int>(
  ...
  late final GeneratedColumn<String> blockedRemoteEtag =
      GeneratedColumn<String>(
        'blocked_remote_etag',
        aliasedName,
        true,
  ...
  late final GeneratedColumn<int> blockedEnvelopeVersion = GeneratedColumn<int>(
  ...
  late final GeneratedColumn<int> blockedObservedAt = GeneratedColumn<int>(
    'blocked_observed_at',
    aliasedName,
    true,
    type: DriftSqlType.int,
  ...
  late final GeneratedColumn<String> recoveryBlockedReason =
      GeneratedColumn<String>(
  ...
  late final GeneratedColumn<int> recoveryBlockedRemoteGeneration =
      GeneratedColumn<int>(
  ...
  late final GeneratedColumn<String> recoveryBlockedRemoteEtag =
      GeneratedColumn<String>(
  ...
  late final GeneratedColumn<int> recoveryBlockedSnapshotRevision =
      GeneratedColumn<int>(
  ...
  late final GeneratedColumn<int> recoveryBlockedObservedAt =
      GeneratedColumn<int>(
  ...
  List<GeneratedColumn> get $columns => [
    ...
    remoteGeneration,
    remoteEtag,
    lastVerifiedSnapshotRevision,
    lastVerifiedContentHash,
    lastVerifiedAt,
    blockedRemoteGeneration,
    blockedRemoteEtag,
    blockedEnvelopeVersion,
    blockedObservedAt,
    recoveryBlockedReason,
    recoveryBlockedRemoteGeneration,
    recoveryBlockedRemoteEtag,
    recoveryBlockedSnapshotRevision,
    recoveryBlockedObservedAt,
  ];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'wallet_metadata_backup_states';
  @override
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  WalletMetadataBackupStatesData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return WalletMetadataBackupStatesData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}id'],
      )!,
      ...
      lastVerifiedSnapshotRevision: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}last_verified_snapshot_revision'],
      ),
      lastVerifiedContentHash: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}last_verified_content_hash'],
      ),
      lastVerifiedAt: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}last_verified_at'],
      ),
      blockedRemoteGeneration: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}blocked_remote_generation'],
      ),
      blockedRemoteEtag: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}blocked_remote_etag'],
      ),
      blockedEnvelopeVersion: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}blocked_envelope_version'],
      ),
      blockedObservedAt: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}blocked_observed_at'],
      ),
      recoveryBlockedReason: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}recovery_blocked_reason'],
      ),
      recoveryBlockedRemoteGeneration: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}recovery_blocked_remote_generation'],
      ),
      recoveryBlockedRemoteEtag: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}recovery_blocked_remote_etag'],
      ),
      recoveryBlockedSnapshotRevision: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}recovery_blocked_snapshot_revision'],
      ),
      recoveryBlockedObservedAt: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}recovery_blocked_observed_at'],
      ),
    );
  }

  @override
  WalletMetadataBackupStates createAlias(String alias) {
    return WalletMetadataBackupStates(attachedDatabase, alias);
  }
...
class WalletMetadataBackupStatesData extends DataClass
    implements Insertable<WalletMetadataBackupStatesData> {
  final int id;
  final int enabled;
  final int dirty;
  final int dirtyRevision;
  ...
  final int? remoteGeneration;
  final String? remoteEtag;
  final int? lastVerifiedSnapshotRevision;
  final String? lastVerifiedContentHash;
  final int? lastVerifiedAt;
  final int? blockedRemoteGeneration;
  final String? blockedRemoteEtag;
  final int? blockedEnvelopeVersion;
  final int? blockedObservedAt;
  final String? recoveryBlockedReason;
  final int? recoveryBlockedRemoteGeneration;
  final String? recoveryBlockedRemoteEtag;
  final int? recoveryBlockedSnapshotRevision;
  final int? recoveryBlockedObservedAt;
  const WalletMetadataBackupStatesData({
    required this.id,
    required this.enabled,
    required this.dirty,
    required this.dirtyRevision,
    ...
    this.remoteGeneration,
    this.remoteEtag,
    this.lastVerifiedSnapshotRevision,
    this.lastVerifiedContentHash,
    this.lastVerifiedAt,
    this.blockedRemoteGeneration,
    this.blockedRemoteEtag,
    this.blockedEnvelopeVersion,
    this.blockedObservedAt,
    this.recoveryBlockedReason,
    this.recoveryBlockedRemoteGeneration,
    this.recoveryBlockedRemoteEtag,
    this.recoveryBlockedSnapshotRevision,
    this.recoveryBlockedObservedAt,
  });
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    ...
    if (!nullToAbsent || lastVerifiedSnapshotRevision != null) {
      map['last_verified_snapshot_revision'] = Variable<int>(
        lastVerifiedSnapshotRevision,
      );
    }
    if (!nullToAbsent || lastVerifiedContentHash != null) {
      map['last_verified_content_hash'] = Variable<String>(
        lastVerifiedContentHash,
      );
    }
    ...
    if (!nullToAbsent || blockedRemoteGeneration != null) {
      map['blocked_remote_generation'] = Variable<int>(blockedRemoteGeneration);
    }
    if (!nullToAbsent || blockedRemoteEtag != null) {
      map['blocked_remote_etag'] = Variable<String>(blockedRemoteEtag);
    }
    if (!nullToAbsent || blockedEnvelopeVersion != null) {
      map['blocked_envelope_version'] = Variable<int>(blockedEnvelopeVersion);
    }
    if (!nullToAbsent || blockedObservedAt != null) {
      map['blocked_observed_at'] = Variable<int>(blockedObservedAt);
    }
    if (!nullToAbsent || recoveryBlockedReason != null) {
      map['recovery_blocked_reason'] = Variable<String>(recoveryBlockedReason);
    }
    if (!nullToAbsent || recoveryBlockedRemoteGeneration != null) {
      map['recovery_blocked_remote_generation'] = Variable<int>(
        recoveryBlockedRemoteGeneration,
      );
    }
    if (!nullToAbsent || recoveryBlockedRemoteEtag != null) {
      map['recovery_blocked_remote_etag'] = Variable<String>(
        recoveryBlockedRemoteEtag,
      );
    }
    if (!nullToAbsent || recoveryBlockedSnapshotRevision != null) {
      map['recovery_blocked_snapshot_revision'] = Variable<int>(
        recoveryBlockedSnapshotRevision,
      );
    }
    if (!nullToAbsent || recoveryBlockedObservedAt != null) {
      map['recovery_blocked_observed_at'] = Variable<int>(
        recoveryBlockedObservedAt,
      );
    }
    return map;
  ...
  WalletMetadataBackupStatesCompanion toCompanion(bool nullToAbsent) {
    return WalletMetadataBackupStatesCompanion(
      id: Value(id),
      enabled: Value(enabled),
      dirty: Value(dirty),
      dirtyRevision: Value(dirtyRevision),
      ...
      remoteEtag: remoteEtag == null && nullToAbsent
          ...
          : Value(remoteEtag),
      lastVerifiedSnapshotRevision:
          lastVerifiedSnapshotRevision == null && nullToAbsent
          ? const Value.absent()
          : Value(lastVerifiedSnapshotRevision),
      lastVerifiedContentHash: lastVerifiedContentHash == null && nullToAbsent
          ? const Value.absent()
          : Value(lastVerifiedContentHash),
      lastVerifiedAt: lastVerifiedAt == null && nullToAbsent
          ? const Value.absent()
          : Value(lastVerifiedAt),
      blockedRemoteGeneration: blockedRemoteGeneration == null && nullToAbsent
          ? const Value.absent()
          : Value(blockedRemoteGeneration),
      blockedRemoteEtag: blockedRemoteEtag == null && nullToAbsent
          ? const Value.absent()
          : Value(blockedRemoteEtag),
      blockedEnvelopeVersion: blockedEnvelopeVersion == null && nullToAbsent
          ? const Value.absent()
          : Value(blockedEnvelopeVersion),
      blockedObservedAt: blockedObservedAt == null && nullToAbsent
          ? const Value.absent()
          : Value(blockedObservedAt),
      recoveryBlockedReason: recoveryBlockedReason == null && nullToAbsent
          ? const Value.absent()
          : Value(recoveryBlockedReason),
      recoveryBlockedRemoteGeneration:
          recoveryBlockedRemoteGeneration == null && nullToAbsent
          ? const Value.absent()
          : Value(recoveryBlockedRemoteGeneration),
      recoveryBlockedRemoteEtag:
          recoveryBlockedRemoteEtag == null && nullToAbsent
          ? const Value.absent()
          : Value(recoveryBlockedRemoteEtag),
      recoveryBlockedSnapshotRevision:
          recoveryBlockedSnapshotRevision == null && nullToAbsent
          ? const Value.absent()
          : Value(recoveryBlockedSnapshotRevision),
      recoveryBlockedObservedAt:
          recoveryBlockedObservedAt == null && nullToAbsent
          ? const Value.absent()
          : Value(recoveryBlockedObservedAt),
    );
  }

  factory WalletMetadataBackupStatesData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return WalletMetadataBackupStatesData(
      ...
      remoteGeneration: serializer.fromJson<int?>(json['remoteGeneration']),
      remoteEtag: serializer.fromJson<String?>(json['remoteEtag']),
      lastVerifiedSnapshotRevision: serializer.fromJson<int?>(
        json['lastVerifiedSnapshotRevision'],
      ),
      lastVerifiedContentHash: serializer.fromJson<String?>(
        json['lastVerifiedContentHash'],
      ),
      lastVerifiedAt: serializer.fromJson<int?>(json['lastVerifiedAt']),
      blockedRemoteGeneration: serializer.fromJson<int?>(
        json['blockedRemoteGeneration'],
      ),
      blockedRemoteEtag: serializer.fromJson<String?>(
        json['blockedRemoteEtag'],
      ),
      blockedEnvelopeVersion: serializer.fromJson<int?>(
        json['blockedEnvelopeVersion'],
      ),
      blockedObservedAt: serializer.fromJson<int?>(json['blockedObservedAt']),
      recoveryBlockedReason: serializer.fromJson<String?>(
        json['recoveryBlockedReason'],
      ),
      recoveryBlockedRemoteGeneration: serializer.fromJson<int?>(
        json['recoveryBlockedRemoteGeneration'],
      ),
      recoveryBlockedRemoteEtag: serializer.fromJson<String?>(
        json['recoveryBlockedRemoteEtag'],
      ),
      recoveryBlockedSnapshotRevision: serializer.fromJson<int?>(
        json['recoveryBlockedSnapshotRevision'],
      ),
      recoveryBlockedObservedAt: serializer.fromJson<int?>(
        json['recoveryBlockedObservedAt'],
      ),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'remoteGeneration': serializer.toJson<int?>(remoteGeneration),
      'remoteEtag': serializer.toJson<String?>(remoteEtag),
      'lastVerifiedSnapshotRevision': serializer.toJson<int?>(
        lastVerifiedSnapshotRevision,
      ),
      'lastVerifiedContentHash': serializer.toJson<String?>(
        lastVerifiedContentHash,
      ),
      'lastVerifiedAt': serializer.toJson<int?>(lastVerifiedAt),
      'blockedRemoteGeneration': serializer.toJson<int?>(
        blockedRemoteGeneration,
      ),
      'blockedRemoteEtag': serializer.toJson<String?>(blockedRemoteEtag),
      'blockedEnvelopeVersion': serializer.toJson<int?>(blockedEnvelopeVersion),
      'blockedObservedAt': serializer.toJson<int?>(blockedObservedAt),
      'recoveryBlockedReason': serializer.toJson<String?>(
        recoveryBlockedReason,
      ),
      'recoveryBlockedRemoteGeneration': serializer.toJson<int?>(
        recoveryBlockedRemoteGeneration,
      ),
      'recoveryBlockedRemoteEtag': serializer.toJson<String?>(
        recoveryBlockedRemoteEtag,
      ),
      'recoveryBlockedSnapshotRevision': serializer.toJson<int?>(
        recoveryBlockedSnapshotRevision,
      ),
      'recoveryBlockedObservedAt': serializer.toJson<int?>(
        recoveryBlockedObservedAt,
      ),
    };
  }

  WalletMetadataBackupStatesData copyWith({
    int? id,
    int? enabled,
    int? dirty,
    int? dirtyRevision,
    ...
    Value<String?> remoteEtag = const Value.absent(),
    Value<int?> lastVerifiedSnapshotRevision = const Value.absent(),
    Value<String?> lastVerifiedContentHash = const Value.absent(),
    Value<int?> lastVerifiedAt = const Value.absent(),
    Value<int?> blockedRemoteGeneration = const Value.absent(),
    Value<String?> blockedRemoteEtag = const Value.absent(),
    Value<int?> blockedEnvelopeVersion = const Value.absent(),
    Value<int?> blockedObservedAt = const Value.absent(),
    Value<String?> recoveryBlockedReason = const Value.absent(),
    Value<int?> recoveryBlockedRemoteGeneration = const Value.absent(),
    Value<String?> recoveryBlockedRemoteEtag = const Value.absent(),
    Value<int?> recoveryBlockedSnapshotRevision = const Value.absent(),
    Value<int?> recoveryBlockedObservedAt = const Value.absent(),
  }) => WalletMetadataBackupStatesData(
    id: id ?? this.id,
    enabled: enabled ?? this.enabled,
    dirty: dirty ?? this.dirty,
    dirtyRevision: dirtyRevision ?? this.dirtyRevision,
    ...
    remoteGeneration: remoteGeneration.present
        ...
        : this.remoteGeneration,
    remoteEtag: remoteEtag.present ? remoteEtag.value : this.remoteEtag,
    lastVerifiedSnapshotRevision: lastVerifiedSnapshotRevision.present
        ? lastVerifiedSnapshotRevision.value
        : this.lastVerifiedSnapshotRevision,
    lastVerifiedContentHash: lastVerifiedContentHash.present
        ? lastVerifiedContentHash.value
        : this.lastVerifiedContentHash,
    lastVerifiedAt: lastVerifiedAt.present
        ? lastVerifiedAt.value
        : this.lastVerifiedAt,
    blockedRemoteGeneration: blockedRemoteGeneration.present
        ? blockedRemoteGeneration.value
        : this.blockedRemoteGeneration,
    blockedRemoteEtag: blockedRemoteEtag.present
        ? blockedRemoteEtag.value
        : this.blockedRemoteEtag,
    blockedEnvelopeVersion: blockedEnvelopeVersion.present
        ? blockedEnvelopeVersion.value
        : this.blockedEnvelopeVersion,
    blockedObservedAt: blockedObservedAt.present
        ? blockedObservedAt.value
        : this.blockedObservedAt,
    recoveryBlockedReason: recoveryBlockedReason.present
        ? recoveryBlockedReason.value
        : this.recoveryBlockedReason,
    recoveryBlockedRemoteGeneration: recoveryBlockedRemoteGeneration.present
        ? recoveryBlockedRemoteGeneration.value
        : this.recoveryBlockedRemoteGeneration,
    recoveryBlockedRemoteEtag: recoveryBlockedRemoteEtag.present
        ? recoveryBlockedRemoteEtag.value
        : this.recoveryBlockedRemoteEtag,
    recoveryBlockedSnapshotRevision: recoveryBlockedSnapshotRevision.present
        ? recoveryBlockedSnapshotRevision.value
        : this.recoveryBlockedSnapshotRevision,
    recoveryBlockedObservedAt: recoveryBlockedObservedAt.present
        ? recoveryBlockedObservedAt.value
        : this.recoveryBlockedObservedAt,
  );
  WalletMetadataBackupStatesData copyWithCompanion(
    WalletMetadataBackupStatesCompanion data,
  ) {
    return WalletMetadataBackupStatesData(
      id: data.id.present ? data.id.value : this.id,
      enabled: data.enabled.present ? data.enabled.value : this.enabled,
      ...
      remoteEtag: data.remoteEtag.present
          ? data.remoteEtag.value
          : this.remoteEtag,
      lastVerifiedSnapshotRevision: data.lastVerifiedSnapshotRevision.present
          ? data.lastVerifiedSnapshotRevision.value
          : this.lastVerifiedSnapshotRevision,
      lastVerifiedContentHash: data.lastVerifiedContentHash.present
          ? data.lastVerifiedContentHash.value
          : this.lastVerifiedContentHash,
      lastVerifiedAt: data.lastVerifiedAt.present
          ? data.lastVerifiedAt.value
          : this.lastVerifiedAt,
      blockedRemoteGeneration: data.blockedRemoteGeneration.present
          ? data.blockedRemoteGeneration.value
          : this.blockedRemoteGeneration,
      blockedRemoteEtag: data.blockedRemoteEtag.present
          ? data.blockedRemoteEtag.value
          : this.blockedRemoteEtag,
      blockedEnvelopeVersion: data.blockedEnvelopeVersion.present
          ? data.blockedEnvelopeVersion.value
          : this.blockedEnvelopeVersion,
      blockedObservedAt: data.blockedObservedAt.present
          ? data.blockedObservedAt.value
          : this.blockedObservedAt,
      recoveryBlockedReason: data.recoveryBlockedReason.present
          ? data.recoveryBlockedReason.value
          : this.recoveryBlockedReason,
      recoveryBlockedRemoteGeneration:
          data.recoveryBlockedRemoteGeneration.present
          ? data.recoveryBlockedRemoteGeneration.value
          : this.recoveryBlockedRemoteGeneration,
      recoveryBlockedRemoteEtag: data.recoveryBlockedRemoteEtag.present
          ? data.recoveryBlockedRemoteEtag.value
          : this.recoveryBlockedRemoteEtag,
      recoveryBlockedSnapshotRevision:
          data.recoveryBlockedSnapshotRevision.present
          ? data.recoveryBlockedSnapshotRevision.value
          : this.recoveryBlockedSnapshotRevision,
      recoveryBlockedObservedAt: data.recoveryBlockedObservedAt.present
          ? data.recoveryBlockedObservedAt.value
          : this.recoveryBlockedObservedAt,
    );
  }
  ...
  @override
  String toString() {
    return (StringBuffer('WalletMetadataBackupStatesData(')
          ..write('id: $id, ')
          ..write('enabled: $enabled, ')
          ..write('dirty: $dirty, ')
          ..write('dirtyRevision: $dirtyRevision, ')
          ...
          ..write('remoteEtag: $remoteEtag, ')
          ..write(
            'lastVerifiedSnapshotRevision: $lastVerifiedSnapshotRevision, ',
          )
          ..write('lastVerifiedContentHash: $lastVerifiedContentHash, ')
          ..write('lastVerifiedAt: $lastVerifiedAt, ')
          ..write('blockedRemoteGeneration: $blockedRemoteGeneration, ')
          ..write('blockedRemoteEtag: $blockedRemoteEtag, ')
          ..write('blockedEnvelopeVersion: $blockedEnvelopeVersion, ')
          ..write('blockedObservedAt: $blockedObservedAt, ')
          ..write('recoveryBlockedReason: $recoveryBlockedReason, ')
          ..write(
            'recoveryBlockedRemoteGeneration: $recoveryBlockedRemoteGeneration, ',
          )
          ..write('recoveryBlockedRemoteEtag: $recoveryBlockedRemoteEtag, ')
          ..write(
            'recoveryBlockedSnapshotRevision: $recoveryBlockedSnapshotRevision, ',
          )
          ..write('recoveryBlockedObservedAt: $recoveryBlockedObservedAt')
          ..write(')'))
        .toString();
  }
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is WalletMetadataBackupStatesData &&
          other.id == this.id &&
          other.enabled == this.enabled &&
          other.dirty == this.dirty &&
          other.dirtyRevision == this.dirtyRevision &&
          ...
          other.remoteGeneration == this.remoteGeneration &&
          other.remoteEtag == this.remoteEtag &&
          other.lastVerifiedSnapshotRevision ==
              this.lastVerifiedSnapshotRevision &&
          other.lastVerifiedContentHash == this.lastVerifiedContentHash &&
          other.lastVerifiedAt == this.lastVerifiedAt &&
          other.blockedRemoteGeneration == this.blockedRemoteGeneration &&
          other.blockedRemoteEtag == this.blockedRemoteEtag &&
          other.blockedEnvelopeVersion == this.blockedEnvelopeVersion &&
          other.blockedObservedAt == this.blockedObservedAt &&
          other.recoveryBlockedReason == this.recoveryBlockedReason &&
          other.recoveryBlockedRemoteGeneration ==
              this.recoveryBlockedRemoteGeneration &&
          other.recoveryBlockedRemoteEtag == this.recoveryBlockedRemoteEtag &&
          other.recoveryBlockedSnapshotRevision ==
              this.recoveryBlockedSnapshotRevision &&
          other.recoveryBlockedObservedAt == this.recoveryBlockedObservedAt);
}

class WalletMetadataBackupStatesCompanion
    extends UpdateCompanion<WalletMetadataBackupStatesData> {
  final Value<int> id;
  final Value<int> enabled;
  final Value<int> dirty;
  final Value<int> dirtyRevision;
  ...
  final Value<int?> remoteGeneration;
  final Value<String?> remoteEtag;
  final Value<int?> lastVerifiedSnapshotRevision;
  final Value<String?> lastVerifiedContentHash;
  final Value<int?> lastVerifiedAt;
  final Value<int?> blockedRemoteGeneration;
  final Value<String?> blockedRemoteEtag;
  final Value<int?> blockedEnvelopeVersion;
  final Value<int?> blockedObservedAt;
  final Value<String?> recoveryBlockedReason;
  final Value<int?> recoveryBlockedRemoteGeneration;
  final Value<String?> recoveryBlockedRemoteEtag;
  final Value<int?> recoveryBlockedSnapshotRevision;
  final Value<int?> recoveryBlockedObservedAt;
  const WalletMetadataBackupStatesCompanion({
    this.id = const Value.absent(),
    this.enabled = const Value.absent(),
    this.dirty = const Value.absent(),
    this.dirtyRevision = const Value.absent(),
    ...
    this.remoteGeneration = const Value.absent(),
    this.remoteEtag = const Value.absent(),
    this.lastVerifiedSnapshotRevision = const Value.absent(),
    this.lastVerifiedContentHash = const Value.absent(),
    this.lastVerifiedAt = const Value.absent(),
    this.blockedRemoteGeneration = const Value.absent(),
    this.blockedRemoteEtag = const Value.absent(),
    this.blockedEnvelopeVersion = const Value.absent(),
    this.blockedObservedAt = const Value.absent(),
    this.recoveryBlockedReason = const Value.absent(),
    this.recoveryBlockedRemoteGeneration = const Value.absent(),
    this.recoveryBlockedRemoteEtag = const Value.absent(),
    this.recoveryBlockedSnapshotRevision = const Value.absent(),
    this.recoveryBlockedObservedAt = const Value.absent(),
  });
  WalletMetadataBackupStatesCompanion.insert({
    this.id = const Value.absent(),
    this.enabled = const Value.absent(),
    this.dirty = const Value.absent(),
    this.dirtyRevision = const Value.absent(),
  ...
  static Insertable<WalletMetadataBackupStatesData> custom({
    Expression<int>? id,
    Expression<int>? enabled,
    Expression<int>? dirty,
    Expression<int>? dirtyRevision,
    ...
    Expression<int>? remoteGeneration,
    Expression<String>? remoteEtag,
    Expression<int>? lastVerifiedSnapshotRevision,
    Expression<String>? lastVerifiedContentHash,
    Expression<int>? lastVerifiedAt,
    Expression<int>? blockedRemoteGeneration,
    Expression<String>? blockedRemoteEtag,
    Expression<int>? blockedEnvelopeVersion,
    Expression<int>? blockedObservedAt,
    Expression<String>? recoveryBlockedReason,
    Expression<int>? recoveryBlockedRemoteGeneration,
    Expression<String>? recoveryBlockedRemoteEtag,
    Expression<int>? recoveryBlockedSnapshotRevision,
    Expression<int>? recoveryBlockedObservedAt,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (enabled != null) 'enabled': enabled,
      ...
      if (remoteGeneration != null) 'remote_generation': remoteGeneration,
      if (remoteEtag != null) 'remote_etag': remoteEtag,
      if (lastVerifiedSnapshotRevision != null)
        'last_verified_snapshot_revision': lastVerifiedSnapshotRevision,
      if (lastVerifiedContentHash != null)
        'last_verified_content_hash': lastVerifiedContentHash,
      if (lastVerifiedAt != null) 'last_verified_at': lastVerifiedAt,
      if (blockedRemoteGeneration != null)
        'blocked_remote_generation': blockedRemoteGeneration,
      if (blockedRemoteEtag != null) 'blocked_remote_etag': blockedRemoteEtag,
      if (blockedEnvelopeVersion != null)
        'blocked_envelope_version': blockedEnvelopeVersion,
      if (blockedObservedAt != null) 'blocked_observed_at': blockedObservedAt,
      if (recoveryBlockedReason != null)
        'recovery_blocked_reason': recoveryBlockedReason,
      if (recoveryBlockedRemoteGeneration != null)
        'recovery_blocked_remote_generation': recoveryBlockedRemoteGeneration,
      if (recoveryBlockedRemoteEtag != null)
        'recovery_blocked_remote_etag': recoveryBlockedRemoteEtag,
      if (recoveryBlockedSnapshotRevision != null)
        'recovery_blocked_snapshot_revision': recoveryBlockedSnapshotRevision,
      if (recoveryBlockedObservedAt != null)
        'recovery_blocked_observed_at': recoveryBlockedObservedAt,
    });
  }

  WalletMetadataBackupStatesCompanion copyWith({
    Value<int>? id,
    Value<int>? enabled,
    Value<int>? dirty,
    Value<int>? dirtyRevision,
    ...
    Value<int?>? remoteGeneration,
    Value<String?>? remoteEtag,
    Value<int?>? lastVerifiedSnapshotRevision,
    Value<String?>? lastVerifiedContentHash,
    Value<int?>? lastVerifiedAt,
    Value<int?>? blockedRemoteGeneration,
    Value<String?>? blockedRemoteEtag,
    Value<int?>? blockedEnvelopeVersion,
    Value<int?>? blockedObservedAt,
    Value<String?>? recoveryBlockedReason,
    Value<int?>? recoveryBlockedRemoteGeneration,
    Value<String?>? recoveryBlockedRemoteEtag,
    Value<int?>? recoveryBlockedSnapshotRevision,
    Value<int?>? recoveryBlockedObservedAt,
  }) {
    return WalletMetadataBackupStatesCompanion(
      id: id ?? this.id,
      enabled: enabled ?? this.enabled,
      ...
      remoteEtag: remoteEtag ?? this.remoteEtag,
      lastVerifiedSnapshotRevision:
          lastVerifiedSnapshotRevision ?? this.lastVerifiedSnapshotRevision,
      lastVerifiedContentHash:
          lastVerifiedContentHash ?? this.lastVerifiedContentHash,
      lastVerifiedAt: lastVerifiedAt ?? this.lastVerifiedAt,
      blockedRemoteGeneration:
          blockedRemoteGeneration ?? this.blockedRemoteGeneration,
      blockedRemoteEtag: blockedRemoteEtag ?? this.blockedRemoteEtag,
      blockedEnvelopeVersion:
          blockedEnvelopeVersion ?? this.blockedEnvelopeVersion,
      blockedObservedAt: blockedObservedAt ?? this.blockedObservedAt,
      recoveryBlockedReason:
          recoveryBlockedReason ?? this.recoveryBlockedReason,
      recoveryBlockedRemoteGeneration:
          recoveryBlockedRemoteGeneration ??
          this.recoveryBlockedRemoteGeneration,
      recoveryBlockedRemoteEtag:
          recoveryBlockedRemoteEtag ?? this.recoveryBlockedRemoteEtag,
      recoveryBlockedSnapshotRevision:
          recoveryBlockedSnapshotRevision ??
          this.recoveryBlockedSnapshotRevision,
      recoveryBlockedObservedAt:
          recoveryBlockedObservedAt ?? this.recoveryBlockedObservedAt,
    );
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (lastVerifiedSnapshotRevision.present) {
      map['last_verified_snapshot_revision'] = Variable<int>(
        lastVerifiedSnapshotRevision.value,
      );
    }
    if (lastVerifiedContentHash.present) {
      map['last_verified_content_hash'] = Variable<String>(
        lastVerifiedContentHash.value,
      );
    }
    ...
    if (blockedRemoteGeneration.present) {
      map['blocked_remote_generation'] = Variable<int>(
        blockedRemoteGeneration.value,
      );
    }
    if (blockedRemoteEtag.present) {
      map['blocked_remote_etag'] = Variable<String>(blockedRemoteEtag.value);
    }
    if (blockedEnvelopeVersion.present) {
      map['blocked_envelope_version'] = Variable<int>(
        blockedEnvelopeVersion.value,
      );
    }
    if (blockedObservedAt.present) {
      map['blocked_observed_at'] = Variable<int>(blockedObservedAt.value);
    }
    if (recoveryBlockedReason.present) {
      map['recovery_blocked_reason'] = Variable<String>(
        recoveryBlockedReason.value,
      );
    }
    if (recoveryBlockedRemoteGeneration.present) {
      map['recovery_blocked_remote_generation'] = Variable<int>(
        recoveryBlockedRemoteGeneration.value,
      );
    }
    if (recoveryBlockedRemoteEtag.present) {
      map['recovery_blocked_remote_etag'] = Variable<String>(
        recoveryBlockedRemoteEtag.value,
      );
    }
    if (recoveryBlockedSnapshotRevision.present) {
      map['recovery_blocked_snapshot_revision'] = Variable<int>(
        recoveryBlockedSnapshotRevision.value,
      );
    }
    if (recoveryBlockedObservedAt.present) {
      map['recovery_blocked_observed_at'] = Variable<int>(
        recoveryBlockedObservedAt.value,
      );
    }
  ...
  @override
  String toString() {
    return (StringBuffer('WalletMetadataBackupStatesCompanion(')
          ..write('id: $id, ')
          ..write('enabled: $enabled, ')
          ..write('dirty: $dirty, ')
          ..write('dirtyRevision: $dirtyRevision, ')
...
class DatabaseAtV17 extends GeneratedDatabase {
  ...
  late final KeychainManifestBackupStates keychainManifestBackupStates =
      KeychainManifestBackupStates(this);
  ...
  late final WalletMetadataBackupStates walletMetadataBackupStates =
      WalletMetadataBackupStates(this);
  @override
