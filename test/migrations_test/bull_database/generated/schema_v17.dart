...
class WalletMetadatas extends Table
  ...
  late final GeneratedColumn<String> publicDescriptor = GeneratedColumn<String>(
    'public_descriptor',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  WalletMetadatasData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return WalletMetadatasData(
      ...
      publicDescriptor: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}public_descriptor'],
      )!,
  ...
  WalletMetadatasData copyWithCompanion(WalletMetadatasCompanion data) {
    return WalletMetadatasData(
      ...
      latestPhysicalBackup: data.latestPhysicalBackup.present
          ...
          : this.latestPhysicalBackup,
      publicDescriptor: data.publicDescriptor.present
...
class WalletMetadatasCompanion extends UpdateCompanion<WalletMetadatasData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (publicDescriptor.present) {
      map['public_descriptor'] = Variable<String>(publicDescriptor.value);
    }
...
class WalletSigners extends Table
    with TableInfo<WalletSigners, WalletSignersData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  WalletSigners(this.attachedDatabase, [this._alias]);
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'wallet_signers';
  @override
  Set<GeneratedColumn> get $primaryKey => {walletId, id};
  @override
  List<Set<GeneratedColumn>> get uniqueKeys => [
    {walletId, position},
  ];
  @override
  WalletSignersData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  WalletSigners createAlias(String alias) {
    return WalletSigners(attachedDatabase, alias);
  }
...
class WalletSignersData extends DataClass
    implements Insertable<WalletSignersData> {
  ...
  WalletSignersCompanion toCompanion(bool nullToAbsent) {
  ...
  factory WalletSignersData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  @override
  String toString() {
    return (StringBuffer('WalletSignersData(')
...
class WalletSignersCompanion extends UpdateCompanion<WalletSignersData> {
  ...
  WalletSignersCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       position = Value(position),
       signer = Value(signer);
  static Insertable<WalletSignersData> custom({
  ...
  WalletSignersCompanion copyWith({
  ...
  @override
  String toString() {
    return (StringBuffer('WalletSignersCompanion(')
          ..write('walletId: $walletId, ')
          ..write('id: $id, ')
          ..write('position: $position, ')
          ..write('signer: $signer, ')
...
class WalletDescriptorKeys extends Table
    with TableInfo<WalletDescriptorKeys, WalletDescriptorKeysData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  WalletDescriptorKeys(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> walletId = GeneratedColumn<String>(
    'wallet_id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<String> descriptorPath = GeneratedColumn<String>(
    'descriptor_path',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'wallet_descriptor_keys';
  @override
  Set<GeneratedColumn> get $primaryKey => {walletId, id};
  @override
  List<Set<GeneratedColumn>> get uniqueKeys => [
  ...
  @override
  WalletDescriptorKeysData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return WalletDescriptorKeysData(
      walletId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}wallet_id'],
      )!,
      ...
      descriptorPath: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
  ...
  @override
  WalletDescriptorKeys createAlias(String alias) {
    return WalletDescriptorKeys(attachedDatabase, alias);
  }
...
class WalletDescriptorKeysData extends DataClass
    implements Insertable<WalletDescriptorKeysData> {
  final String walletId;
  final String id;
  final int position;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || derivationPath != null) {
  ...
  WalletDescriptorKeysCompanion toCompanion(bool nullToAbsent) {
    return WalletDescriptorKeysCompanion(
      ...
      xpub: Value(xpub),
      derivationPath: derivationPath == null && nullToAbsent
          ? const Value.absent()
  ...
  factory WalletDescriptorKeysData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  WalletDescriptorKeysData copyWith({
    String? walletId,
    String? id,
    int? position,
    String? signerId,
    ...
    xpub: xpub ?? this.xpub,
    derivationPath: derivationPath.present
  ...
  @override
  String toString() {
    return (StringBuffer('WalletDescriptorKeysData(')
          ..write('walletId: $walletId, ')
          ..write('id: $id, ')
          ..write('position: $position, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is WalletDescriptorKeysData &&
          other.walletId == this.walletId &&
          other.id == this.id &&
          other.position == this.position &&
...
class WalletDescriptorKeysCompanion
    extends UpdateCompanion<WalletDescriptorKeysData> {
  final Value<String> walletId;
  final Value<String> id;
  final Value<int> position;
  ...
  WalletDescriptorKeysCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       xpubFingerprint = Value(xpubFingerprint),
       xpub = Value(xpub);
  static Insertable<WalletDescriptorKeysData> custom({
    Expression<String>? walletId,
    Expression<String>? id,
    Expression<int>? position,
  ...
  WalletDescriptorKeysCompanion copyWith({
    Value<String>? walletId,
    Value<String>? id,
    Value<int>? position,
  ...
  @override
  String toString() {
    return (StringBuffer('WalletDescriptorKeysCompanion(')
          ..write('walletId: $walletId, ')
          ..write('id: $id, ')
          ..write('position: $position, ')
          ..write('signerId: $signerId, ')
...
class KeychainManifestEntries extends Table
  ...
  late final GeneratedColumn<String> derivationKind = GeneratedColumn<String>(
    'derivation_kind',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  KeychainManifestEntriesData map(
    ...
    return KeychainManifestEntriesData(
      ...
      derivationKind: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}derivation_kind'],
      )!,
      derivationPath: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}derivation_path'],
...
class KeychainManifestEntriesData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['derivation_kind'] = Variable<String>(derivationKind);
    map['derivation_path'] = Variable<String>(derivationPath);
  ...
  KeychainManifestEntriesCompanion toCompanion(bool nullToAbsent) {
    return KeychainManifestEntriesCompanion(
      ...
      derivationKind: Value(derivationKind),
  ...
  factory KeychainManifestEntriesData.fromJson(
    ...
    return KeychainManifestEntriesData(
      ...
      derivationKind: serializer.fromJson<String>(json['derivationKind']),
      derivationPath: serializer.fromJson<String>(json['derivationPath']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'derivationKind': serializer.toJson<String>(derivationKind),
      'derivationPath': serializer.toJson<String>(derivationPath),
  ...
  KeychainManifestEntriesData copyWith({
    ...
    derivationKind: derivationKind ?? this.derivationKind,
    derivationPath: derivationPath ?? this.derivationPath,
  ...
  KeychainManifestEntriesData copyWithCompanion(
    ...
    return KeychainManifestEntriesData(
      ...
      derivationKind: data.derivationKind.present
          ? data.derivationKind.value
          : this.derivationKind,
      derivationPath: data.derivationPath.present
          ? data.derivationPath.value
          : this.derivationPath,
  ...
  String toString() {
    return (StringBuffer('KeychainManifestEntriesData(')
          ...
          ..write('derivationKind: $derivationKind, ')
          ..write('derivationPath: $derivationPath, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is KeychainManifestEntriesData &&
          ...
          other.derivationKind == this.derivationKind &&
          other.derivationPath == this.derivationPath &&
...
class KeychainManifestEntriesCompanion
  ...
  final Value<String> derivationKind;
  final Value<String> derivationPath;
  ...
  const KeychainManifestEntriesCompanion({
    ...
    this.derivationKind = const Value.absent(),
    this.derivationPath = const Value.absent(),
  ...
  KeychainManifestEntriesCompanion.insert({
    ...
    required String derivationKind,
  ...
  static Insertable<KeychainManifestEntriesData> custom({
    ...
    Expression<String>? derivationKind,
    Expression<String>? derivationPath,
    ...
    return RawValuesInsertable({
      ...
      if (derivationKind != null) 'derivation_kind': derivationKind,
      if (derivationPath != null) 'derivation_path': derivationPath,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (derivationKind.present) {
      map['derivation_kind'] = Variable<String>(derivationKind.value);
    }
    if (derivationPath.present) {
      map['derivation_path'] = Variable<String>(derivationPath.value);
    }
...
class WalletBackupStates extends Table
  ...
  late final GeneratedColumn<int> uploadedRevision = GeneratedColumn<int>(
    'uploaded_revision',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  late final GeneratedColumn<String> lastRecoveryStatus =
      GeneratedColumn<String>(
  ...
  late final GeneratedColumn<String> remoteCiphertextHash =
      GeneratedColumn<String>(
  ...
  WalletBackupStatesData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return WalletBackupStatesData(
      ...
      uploadedRevision: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}uploaded_revision'],
      )!,
      lastSucceededAt: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}last_succeeded_at'],
      ),
      lastRecoveryStatus: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}last_recovery_status'],
      ),
      ...
      remoteCiphertextHash: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
...
class WalletBackupStatesData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['uploaded_revision'] = Variable<int>(uploadedRevision);
    if (!nullToAbsent || lastSucceededAt != null) {
      map['last_succeeded_at'] = Variable<int>(lastSucceededAt);
    }
    if (!nullToAbsent || lastRecoveryStatus != null) {
      map['last_recovery_status'] = Variable<String>(lastRecoveryStatus);
    }
  ...
  WalletBackupStatesCompanion toCompanion(bool nullToAbsent) {
    return WalletBackupStatesCompanion(
      ...
      uploadedRevision: Value(uploadedRevision),
      lastSucceededAt: lastSucceededAt == null && nullToAbsent
          ? const Value.absent()
          : Value(lastSucceededAt),
      lastRecoveryStatus: lastRecoveryStatus == null && nullToAbsent
          ? const Value.absent()
          : Value(lastRecoveryStatus),
  ...
  factory WalletBackupStatesData.fromJson(
    ...
    return WalletBackupStatesData(
      ...
      uploadedRevision: serializer.fromJson<int>(json['uploadedRevision']),
      lastSucceededAt: serializer.fromJson<int?>(json['lastSucceededAt']),
      lastRecoveryStatus: serializer.fromJson<String?>(
        json['lastRecoveryStatus'],
      ),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'uploadedRevision': serializer.toJson<int>(uploadedRevision),
      'lastSucceededAt': serializer.toJson<int?>(lastSucceededAt),
      'lastRecoveryStatus': serializer.toJson<String?>(lastRecoveryStatus),
  ...
  WalletBackupStatesData copyWith({
    ...
    int? enabled,
    int? localRevision,
    int? uploadedRevision,
    Value<int?> lastSucceededAt = const Value.absent(),
    Value<String?> lastRecoveryStatus = const Value.absent(),
    ...
    uploadedRevision: uploadedRevision ?? this.uploadedRevision,
    lastSucceededAt: lastSucceededAt.present
        ? lastSucceededAt.value
        : this.lastSucceededAt,
    lastRecoveryStatus: lastRecoveryStatus.present
        ? lastRecoveryStatus.value
        : this.lastRecoveryStatus,
  ...
  WalletBackupStatesData copyWithCompanion(WalletBackupStatesCompanion data) {
    return WalletBackupStatesData(
      ...
      localRevision: data.localRevision.present
          ...
          : this.localRevision,
      uploadedRevision: data.uploadedRevision.present
          ? data.uploadedRevision.value
          : this.uploadedRevision,
      lastSucceededAt: data.lastSucceededAt.present
          ? data.lastSucceededAt.value
          : this.lastSucceededAt,
      lastRecoveryStatus: data.lastRecoveryStatus.present
          ? data.lastRecoveryStatus.value
          : this.lastRecoveryStatus,
  ...
  String toString() {
    return (StringBuffer('WalletBackupStatesData(')
          ...
          ..write('uploadedRevision: $uploadedRevision, ')
          ..write('lastSucceededAt: $lastSucceededAt, ')
          ..write('lastRecoveryStatus: $lastRecoveryStatus, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is WalletBackupStatesData &&
          ...
          other.uploadedRevision == this.uploadedRevision &&
          other.lastSucceededAt == this.lastSucceededAt &&
          other.lastRecoveryStatus == this.lastRecoveryStatus &&
...
class WalletBackupStatesCompanion
  ...
  final Value<int> uploadedRevision;
  final Value<int?> lastSucceededAt;
  final Value<String?> lastRecoveryStatus;
  ...
  const WalletBackupStatesCompanion({
    ...
    this.uploadedRevision = const Value.absent(),
    this.lastSucceededAt = const Value.absent(),
    this.lastRecoveryStatus = const Value.absent(),
  ...
  static Insertable<WalletBackupStatesData> custom({
    ...
    Expression<int>? uploadedRevision,
    Expression<int>? lastSucceededAt,
    Expression<String>? lastRecoveryStatus,
    ...
    return RawValuesInsertable({
      ...
      if (uploadedRevision != null) 'uploaded_revision': uploadedRevision,
      if (lastSucceededAt != null) 'last_succeeded_at': lastSucceededAt,
      if (lastRecoveryStatus != null)
        'last_recovery_status': lastRecoveryStatus,
  ...
  WalletBackupStatesCompanion copyWith({
    ...
    Value<int>? uploadedRevision,
    Value<int?>? lastSucceededAt,
    Value<String?>? lastRecoveryStatus,
    ...
    return WalletBackupStatesCompanion(
      ...
      lastRecoveryStatus: lastRecoveryStatus ?? this.lastRecoveryStatus,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (uploadedRevision.present) {
      map['uploaded_revision'] = Variable<int>(uploadedRevision.value);
    }
    if (lastSucceededAt.present) {
      map['last_succeeded_at'] = Variable<int>(lastSucceededAt.value);
    }
    if (lastRecoveryStatus.present) {
      map['last_recovery_status'] = Variable<String>(lastRecoveryStatus.value);
    }
    ...
    if (remoteCiphertextHash.present) {
      map['remote_ciphertext_hash'] = Variable<String>(
        remoteCiphertextHash.value,
      );
    }
...
class DatabaseAtV17 extends GeneratedDatabase {
  ...
  late final WalletSigners walletSigners = WalletSigners(this);
  late final WalletDescriptorKeys walletDescriptorKeys = WalletDescriptorKeys(
    this,
  );
  ...
  StreamQueryUpdateRules get streamUpdateRules => const StreamQueryUpdateRules([
    WritePropagation(
      ...
      result: [TableUpdate('wallet_signers', kind: UpdateKind.delete)],
    ),
    WritePropagation(
      on: TableUpdateQuery.onTableName(
        'wallet_metadatas',
