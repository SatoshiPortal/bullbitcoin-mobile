...
class SendTimestamps extends Table
    with TableInfo<SendTimestamps, SendTimestampsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SendTimestamps(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> txid = GeneratedColumn<String>(
    'txid',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<int> sentAtSecs = GeneratedColumn<int>(
    'sent_at_secs',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  @override
  List<GeneratedColumn> get $columns => [txid, sentAtSecs];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'send_timestamps';
  @override
  Set<GeneratedColumn> get $primaryKey => {txid};
  @override
  SendTimestampsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return SendTimestampsData(
      txid: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}txid'],
      )!,
      sentAtSecs: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}sent_at_secs'],
      )!,
    );
  }

  @override
  SendTimestamps createAlias(String alias) {
    return SendTimestamps(attachedDatabase, alias);
  }
...
class SendTimestampsData extends DataClass
    implements Insertable<SendTimestampsData> {
  final String txid;
  final int sentAtSecs;
  const SendTimestampsData({required this.txid, required this.sentAtSecs});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['txid'] = Variable<String>(txid);
    map['sent_at_secs'] = Variable<int>(sentAtSecs);
    return map;
  }

  SendTimestampsCompanion toCompanion(bool nullToAbsent) {
    return SendTimestampsCompanion(
      txid: Value(txid),
      sentAtSecs: Value(sentAtSecs),
    );
  }

  factory SendTimestampsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return SendTimestampsData(
      txid: serializer.fromJson<String>(json['txid']),
      sentAtSecs: serializer.fromJson<int>(json['sentAtSecs']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'txid': serializer.toJson<String>(txid),
      'sentAtSecs': serializer.toJson<int>(sentAtSecs),
    };
  }

  SendTimestampsData copyWith({String? txid, int? sentAtSecs}) =>
      SendTimestampsData(
        txid: txid ?? this.txid,
        sentAtSecs: sentAtSecs ?? this.sentAtSecs,
      );
  SendTimestampsData copyWithCompanion(SendTimestampsCompanion data) {
    return SendTimestampsData(
      txid: data.txid.present ? data.txid.value : this.txid,
      sentAtSecs: data.sentAtSecs.present
          ? data.sentAtSecs.value
          : this.sentAtSecs,
    );
  }
  ...
  @override
  String toString() {
    return (StringBuffer('SendTimestampsData(')
          ..write('txid: $txid, ')
          ..write('sentAtSecs: $sentAtSecs')
          ..write(')'))
        .toString();
  }

  @override
  int get hashCode => Object.hash(txid, sentAtSecs);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is SendTimestampsData &&
          other.txid == this.txid &&
          other.sentAtSecs == this.sentAtSecs);
}

class SendTimestampsCompanion extends UpdateCompanion<SendTimestampsData> {
  final Value<String> txid;
  final Value<int> sentAtSecs;
  final Value<int> rowid;
  const SendTimestampsCompanion({
    this.txid = const Value.absent(),
    this.sentAtSecs = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  SendTimestampsCompanion.insert({
    required String txid,
    required int sentAtSecs,
    this.rowid = const Value.absent(),
  }) : txid = Value(txid),
       sentAtSecs = Value(sentAtSecs);
  static Insertable<SendTimestampsData> custom({
    Expression<String>? txid,
    Expression<int>? sentAtSecs,
    Expression<int>? rowid,
  }) {
    return RawValuesInsertable({
      if (txid != null) 'txid': txid,
      if (sentAtSecs != null) 'sent_at_secs': sentAtSecs,
      if (rowid != null) 'rowid': rowid,
    });
  }

  SendTimestampsCompanion copyWith({
    Value<String>? txid,
    Value<int>? sentAtSecs,
    Value<int>? rowid,
  }) {
    return SendTimestampsCompanion(
      txid: txid ?? this.txid,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (sentAtSecs.present) {
      map['sent_at_secs'] = Variable<int>(sentAtSecs.value);
    }
    if (rowid.present) {
      map['rowid'] = Variable<int>(rowid.value);
    }
  ...
  @override
  String toString() {
    return (StringBuffer('SendTimestampsCompanion(')
          ..write('txid: $txid, ')
          ..write('sentAtSecs: $sentAtSecs, ')
          ..write('rowid: $rowid')
          ..write(')'))
...
class DatabaseAtV16 extends GeneratedDatabase {
  ...
  late final SendTimestamps sendTimestamps = SendTimestamps(this);
