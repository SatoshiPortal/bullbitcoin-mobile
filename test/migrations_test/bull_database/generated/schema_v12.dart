...
class WalletMetadatas extends Table
  ...
  late final GeneratedColumn<String> mnemonicTestedAt = GeneratedColumn<String>(
    'mnemonic_tested_at',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  late final GeneratedColumn<String> encryptedVaultTestedAt =
      GeneratedColumn<String>(
        'encrypted_vault_tested_at',
        aliasedName,
        true,
        type: DriftSqlType.string,
        requiredDuringInsert: false,
  ...
  WalletMetadatasData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return WalletMetadatasData(
      ...
      mnemonicTestedAt: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}mnemonic_tested_at'],
      ),
      encryptedVaultTestedAt: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}encrypted_vault_tested_at'],
      ),
...
class WalletMetadatasData extends DataClass
  ...
  final String? mnemonicTestedAt;
  final String? encryptedVaultTestedAt;
  ...
  const WalletMetadatasData({
    ...
    this.mnemonicTestedAt,
    this.encryptedVaultTestedAt,
    this.syncedAt,
    this.birthday,
  });
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || mnemonicTestedAt != null) {
      map['mnemonic_tested_at'] = Variable<String>(mnemonicTestedAt);
    }
    if (!nullToAbsent || encryptedVaultTestedAt != null) {
      map['encrypted_vault_tested_at'] = Variable<String>(
        encryptedVaultTestedAt,
      );
    }
  ...
  WalletMetadatasCompanion toCompanion(bool nullToAbsent) {
    return WalletMetadatasCompanion(
      ...
      mnemonicTestedAt: mnemonicTestedAt == null && nullToAbsent
          ? const Value.absent()
          : Value(mnemonicTestedAt),
      encryptedVaultTestedAt: encryptedVaultTestedAt == null && nullToAbsent
          ? const Value.absent()
          : Value(encryptedVaultTestedAt),
  ...
  factory WalletMetadatasData.fromJson(
    ...
    return WalletMetadatasData(
      ...
      mnemonicTestedAt: serializer.fromJson<String?>(json['mnemonicTestedAt']),
      encryptedVaultTestedAt: serializer.fromJson<String?>(
        json['encryptedVaultTestedAt'],
      ),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'mnemonicTestedAt': serializer.toJson<String?>(mnemonicTestedAt),
      'encryptedVaultTestedAt': serializer.toJson<String?>(
        encryptedVaultTestedAt,
      ),
  ...
  WalletMetadatasData copyWith({
    ...
    int? isDefault,
    String? network,
    Value<String?> mnemonicTestedAt = const Value.absent(),
    Value<String?> encryptedVaultTestedAt = const Value.absent(),
    ...
    mnemonicTestedAt: mnemonicTestedAt.present
        ? mnemonicTestedAt.value
        : this.mnemonicTestedAt,
    encryptedVaultTestedAt: encryptedVaultTestedAt.present
        ? encryptedVaultTestedAt.value
        : this.encryptedVaultTestedAt,
  ...
  WalletMetadatasData copyWithCompanion(WalletMetadatasCompanion data) {
    return WalletMetadatasData(
      ...
      mnemonicTestedAt: data.mnemonicTestedAt.present
          ? data.mnemonicTestedAt.value
          : this.mnemonicTestedAt,
      encryptedVaultTestedAt: data.encryptedVaultTestedAt.present
          ? data.encryptedVaultTestedAt.value
          : this.encryptedVaultTestedAt,
  ...
  String toString() {
    return (StringBuffer('WalletMetadatasData(')
          ...
          ..write('mnemonicTestedAt: $mnemonicTestedAt, ')
          ..write('encryptedVaultTestedAt: $encryptedVaultTestedAt, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is WalletMetadatasData &&
          ...
          other.mnemonicTestedAt == this.mnemonicTestedAt &&
          other.encryptedVaultTestedAt == this.encryptedVaultTestedAt &&
...
class WalletMetadatasCompanion extends UpdateCompanion<WalletMetadatasData> {
  ...
  final Value<String?> mnemonicTestedAt;
  final Value<String?> encryptedVaultTestedAt;
  ...
  const WalletMetadatasCompanion({
    ...
    this.mnemonicTestedAt = const Value.absent(),
    this.encryptedVaultTestedAt = const Value.absent(),
  ...
  static Insertable<WalletMetadatasData> custom({
    ...
    Expression<String>? mnemonicTestedAt,
    Expression<String>? encryptedVaultTestedAt,
    ...
    return RawValuesInsertable({
      ...
      if (mnemonicTestedAt != null) 'mnemonic_tested_at': mnemonicTestedAt,
      if (encryptedVaultTestedAt != null)
        'encrypted_vault_tested_at': encryptedVaultTestedAt,
  ...
  WalletMetadatasCompanion copyWith({
    ...
    Value<String?>? mnemonicTestedAt,
    Value<String?>? encryptedVaultTestedAt,
    ...
    return WalletMetadatasCompanion(
      ...
      isDefault: isDefault ?? this.isDefault,
      network: network ?? this.network,
      mnemonicTestedAt: mnemonicTestedAt ?? this.mnemonicTestedAt,
      encryptedVaultTestedAt:
          encryptedVaultTestedAt ?? this.encryptedVaultTestedAt,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (mnemonicTestedAt.present) {
      map['mnemonic_tested_at'] = Variable<String>(mnemonicTestedAt.value);
    }
    if (encryptedVaultTestedAt.present) {
      map['encrypted_vault_tested_at'] = Variable<String>(
        encryptedVaultTestedAt.value,
      );
    }
...
class BitcoinWalletConfigs extends Table
    with TableInfo<BitcoinWalletConfigs, BitcoinWalletConfigsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  BitcoinWalletConfigs(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> walletId = GeneratedColumn<int>(
    ...
    requiredDuringInsert: false,
    $customConstraints:
        'NOT NULL REFERENCES wallet_metadatas(id)ON DELETE CASCADE',
  );
  late final GeneratedColumn<String> networkEnvironment =
      GeneratedColumn<String>(
        'network_environment',
        aliasedName,
        false,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'bitcoin_wallet_configs';
  @override
  Set<GeneratedColumn> get $primaryKey => {walletId};
  @override
  BitcoinWalletConfigsData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return BitcoinWalletConfigsData(
      walletId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}wallet_id'],
      )!,
      networkEnvironment: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}network_environment'],
      )!,
  ...
  @override
  BitcoinWalletConfigs createAlias(String alias) {
    return BitcoinWalletConfigs(attachedDatabase, alias);
  }
...
class BitcoinWalletConfigsData extends DataClass
    implements Insertable<BitcoinWalletConfigsData> {
  final int walletId;
  ...
  const BitcoinWalletConfigsData({
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['network_environment'] = Variable<String>(networkEnvironment);
  ...
  BitcoinWalletConfigsCompanion toCompanion(bool nullToAbsent) {
    return BitcoinWalletConfigsCompanion(
  ...
  factory BitcoinWalletConfigsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return BitcoinWalletConfigsData(
      ...
      networkEnvironment: serializer.fromJson<String>(
        json['networkEnvironment'],
      ),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'networkEnvironment': serializer.toJson<String>(networkEnvironment),
  ...
  BitcoinWalletConfigsData copyWith({
    int? walletId,
  ...
  BitcoinWalletConfigsData copyWithCompanion(
    BitcoinWalletConfigsCompanion data,
  ) {
    return BitcoinWalletConfigsData(
      walletId: data.walletId.present ? data.walletId.value : this.walletId,
      networkEnvironment: data.networkEnvironment.present
          ? data.networkEnvironment.value
  ...
  @override
  String toString() {
    return (StringBuffer('BitcoinWalletConfigsData(')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is BitcoinWalletConfigsData &&
          other.walletId == this.walletId &&
          other.networkEnvironment == this.networkEnvironment &&
...
class BitcoinWalletConfigsCompanion
    extends UpdateCompanion<BitcoinWalletConfigsData> {
  final Value<int> walletId;
  final Value<String> networkEnvironment;
  ...
  const BitcoinWalletConfigsCompanion({
    this.walletId = const Value.absent(),
    this.networkEnvironment = const Value.absent(),
  ...
  BitcoinWalletConfigsCompanion.insert({
    this.walletId = const Value.absent(),
    ...
    this.signerDevice = const Value.absent(),
       ...
       internalPublicDescriptor = Value(internalPublicDescriptor),
       signer = Value(signer);
  static Insertable<BitcoinWalletConfigsData> custom({
    Expression<int>? walletId,
    Expression<String>? networkEnvironment,
    ...
    return RawValuesInsertable({
      ...
      if (networkEnvironment != null) 'network_environment': networkEnvironment,
  ...
  BitcoinWalletConfigsCompanion copyWith({
    Value<int>? walletId,
    Value<String>? networkEnvironment,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (networkEnvironment.present) {
      map['network_environment'] = Variable<String>(networkEnvironment.value);
    }
  ...
  @override
  String toString() {
    return (StringBuffer('BitcoinWalletConfigsCompanion(')
          ..write('walletId: $walletId, ')
          ..write('networkEnvironment: $networkEnvironment, ')
          ..write('masterFingerprint: $masterFingerprint, ')
          ..write('xpub: $xpub, ')
...
class LiquidWalletConfigs extends Table
    with TableInfo<LiquidWalletConfigs, LiquidWalletConfigsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  LiquidWalletConfigs(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> walletId = GeneratedColumn<int>(
    'wallet_id',
    aliasedName,
    false,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'liquid_wallet_configs';
  @override
  Set<GeneratedColumn> get $primaryKey => {walletId};
  @override
  LiquidWalletConfigsData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return LiquidWalletConfigsData(
      walletId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}wallet_id'],
      )!,
  ...
  @override
  LiquidWalletConfigs createAlias(String alias) {
    return LiquidWalletConfigs(attachedDatabase, alias);
  }
...
class LiquidWalletConfigsData extends DataClass
    implements Insertable<LiquidWalletConfigsData> {
  final int walletId;
  final String networkEnvironment;
  final String masterFingerprint;
  final String xpub;
  ...
  LiquidWalletConfigsCompanion toCompanion(bool nullToAbsent) {
    return LiquidWalletConfigsCompanion(
      walletId: Value(walletId),
      networkEnvironment: Value(networkEnvironment),
      masterFingerprint: Value(masterFingerprint),
      xpub: Value(xpub),
  ...
  factory LiquidWalletConfigsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  LiquidWalletConfigsData copyWith({
    int? walletId,
    String? networkEnvironment,
    String? masterFingerprint,
    String? xpub,
  ...
  LiquidWalletConfigsData copyWithCompanion(LiquidWalletConfigsCompanion data) {
    return LiquidWalletConfigsData(
      walletId: data.walletId.present ? data.walletId.value : this.walletId,
      networkEnvironment: data.networkEnvironment.present
          ? data.networkEnvironment.value
  ...
  @override
  String toString() {
    return (StringBuffer('LiquidWalletConfigsData(')
          ..write('walletId: $walletId, ')
          ..write('networkEnvironment: $networkEnvironment, ')
          ..write('masterFingerprint: $masterFingerprint, ')
          ..write('xpub: $xpub, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is LiquidWalletConfigsData &&
          other.walletId == this.walletId &&
          other.networkEnvironment == this.networkEnvironment &&
          other.masterFingerprint == this.masterFingerprint &&
          other.xpub == this.xpub &&
...
class LiquidWalletConfigsCompanion
    extends UpdateCompanion<LiquidWalletConfigsData> {
  final Value<int> walletId;
  final Value<String> networkEnvironment;
  final Value<String> masterFingerprint;
  final Value<String> xpub;
  ...
  final Value<String> signer;
  final Value<String?> signerDevice;
  const LiquidWalletConfigsCompanion({
    this.walletId = const Value.absent(),
    this.networkEnvironment = const Value.absent(),
    this.masterFingerprint = const Value.absent(),
    this.xpub = const Value.absent(),
  ...
  LiquidWalletConfigsCompanion.insert({
    this.walletId = const Value.absent(),
    required String networkEnvironment,
    required String masterFingerprint,
    required String xpub,
    ...
    this.signerDevice = const Value.absent(),
       ...
       externalPublicDescriptor = Value(externalPublicDescriptor),
       signer = Value(signer);
  static Insertable<LiquidWalletConfigsData> custom({
    Expression<int>? walletId,
    Expression<String>? networkEnvironment,
    Expression<String>? masterFingerprint,
    Expression<String>? xpub,
  ...
  LiquidWalletConfigsCompanion copyWith({
    Value<int>? walletId,
    Value<String>? networkEnvironment,
    Value<String>? masterFingerprint,
    Value<String>? xpub,
  ...
  @override
  String toString() {
    return (StringBuffer('LiquidWalletConfigsCompanion(')
          ..write('walletId: $walletId, ')
          ..write('networkEnvironment: $networkEnvironment, ')
          ..write('masterFingerprint: $masterFingerprint, ')
          ..write('xpub: $xpub, ')
...
class DatabaseAtV12 extends GeneratedDatabase {
  ...
  late final BitcoinWalletConfigs bitcoinWalletConfigs = BitcoinWalletConfigs(
    this,
  );
  late final LiquidWalletConfigs liquidWalletConfigs = LiquidWalletConfigs(
    this,
  );
  ...
  StreamQueryUpdateRules get streamUpdateRules => const StreamQueryUpdateRules([
    WritePropagation(
      ...
      result: [TableUpdate('bitcoin_wallet_configs', kind: UpdateKind.delete)],
    ),
    WritePropagation(
      on: TableUpdateQuery.onTableName(
        'wallet_metadatas',
      ...
      result: [TableUpdate('liquid_wallet_configs', kind: UpdateKind.delete)],
    ),
  ]);
  @override
