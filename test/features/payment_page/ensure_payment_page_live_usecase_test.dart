...
void main() {
  ...
  test('registration live but page row absent -> needsReactivation, no PUT',
      () async {
  ...
  test('page GET unreachable -> unreachable, never fake-live, zero writes',
      () async {
  ...
  test('no nym (NymNotFound) -> needsReactivation, never touches the page',
      () async {
    final la = laFacade(
