...
void main() {
  ...
  test(
    'resolves identity, prepares the wallet, then sends the signed save',
    () async {
      stubPrepared();
  ...
  test(
    'refuses an empty descriptor before signing/wire (KR-1 guard)',
    () async {
  ...
  test(
    'a minimal save (no optionals) still sends the prepared descriptor',
    () async {
