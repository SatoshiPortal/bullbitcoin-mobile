  ...
  testWidgets('renders coins with amount, source badge, and confirmation', (
    ...
    await loadWith(tester, [
      SpCoin(
        ...
        outpoint: (txId: 'aabbccddeeff00112233', vout: 0),
      ...
      SpCoin(
        ...
        outpoint: (txId: 'ffeeddccbbaa99887766', vout: 1),
      ...
      SpCoin(
        source: SpCoinSource.sp,
        outpoint: (txId: 'cafebabedeadbeef0011', vout: 2),
        amountSat: Sats.fromInt(7000),
        height: 840000,
