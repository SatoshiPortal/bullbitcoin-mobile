...
void main() {
  ...
  group('LoadSpWalletDataUsecase', () {
    test('assembles the wallet data when the session and reads succeed',
        () async {
      final wallet = spWallet(confirmedSat: BigInt.from(700));
      final history = [
        SpPayment(
          txid: 'a',
      ...
      const coins = <SpCoin>[];
      when(() => ensureSpSessionUsecase.execute())
