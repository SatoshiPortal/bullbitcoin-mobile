...
void main() {
  ...
  late SetPayjoinTradingEnabledUsecase usecase;

  setUp(() {
    policy = _MockPayjoinPolicyAccess();
    usecase = SetPayjoinTradingEnabledUsecase(policy);
  });
  ...
  test('maps a persistence failure to a sell error', () async {
    ...
    expect(
      ...
      const SellError.payjoinSettingUpdateFailed(),
    );
  });
}
