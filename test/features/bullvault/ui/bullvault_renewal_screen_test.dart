...
void main() {
  ...
  testWidgets('retries renewal review and blocks Back during creation', (
    tester,
  ) async {
    final details = testBullVaultDetails();
    ...
    await tester.tap(find.text('Review renewal'));
    await tester.pumpAndSettle();
    expect(find.text('Current recovery dates'), findsOneWidget);
    expect(find.text('New recovery dates'), findsNothing);
    ...
    await tester.pumpAndSettle();
    expect(find.text('New recovery dates'), findsOneWidget);
