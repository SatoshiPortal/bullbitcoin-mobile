  ...
  group('frozen wire values', () {
    ...
    test('frozen wire value: BIP85 reservation owner names', () {
      expect(Bip85ReservationOwner.values, [
        ...
        Bip85ReservationOwner.walletMetadataBackup,
      ]);
      ...
      expect(
        Bip85ReservationOwner.walletMetadataBackup.name,
    ...
    test('frozen wire value: BIP85 reservation purpose names', () {
      expect(Bip85ReservationPurpose.values, [
        ...
        Bip85ReservationPurpose.backupSigningKey,
      ...
      expect(Bip85ReservationPurpose.backupSigningKey.name, 'backupSigningKey');
      expect(
