...
import 'package:bull_logs/src/data/logs_repository_impl.dart';
...
void main() {
  test(
    ...
    () async {
      ...
      expect(result, isA<Ok<List<LogEntry>, LogsFailure>>());
      final entries = (result as Ok<List<LogEntry>, LogsFailure>).value;
