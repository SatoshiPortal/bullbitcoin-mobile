...
graph TB
    ...
    WALLET_METADATA_BACKUP[Wallet Metadata Backup]
    ...
    BACKUPS --> BIP85
    BACKUPS --> TOR
    BACKUPS --> WALLET_METADATA_BACKUP
    BACKUPS --> WALLETS
    BTC_PRICE --> SETTINGS
    ...
    AUTOMATIC_FALLBACK --> BULLNYM
    AUTOMATIC_FALLBACK --> LABELS
    AUTOMATIC_FALLBACK --> NOSTR_IDENTITY
    AUTOMATIC_FALLBACK --> WALLETS
    FIAT_SETTLEMENT --> BULLNYM
    FIAT_SETTLEMENT --> NOSTR_IDENTITY
    FIAT_SETTLEMENT --> EXCHANGE
    FIAT_SETTLEMENT --> WALLETS
    FIAT_SETTLEMENT --> SETTINGS
    GET_PAID --> FIAT_SETTLEMENT
    LIGHTNING_ADDRESS --> FIAT_SETTLEMENT
    PAYMENT_PAGE --> FIAT_SETTLEMENT
    POS --> FIAT_SETTLEMENT
    INVOICES --> FIAT_SETTLEMENT
    ...
    WALLET_METADATA_BACKUP --> BIP85_REGISTRY
    WALLET_METADATA_BACKUP --> LABELS
    WALLET_METADATA_BACKUP --> NOSTR_IDENTITY
    WALLET_METADATA_BACKUP --> BULLNYM
    ...
    class SETTINGS,TOR,PIN_CODE,LABELS,SECRETS,HW_WALLETS,BTC_PRICE,BTCPAY,NETWORK,BIP85,BIP85_REGISTRY,DETERMINISTIC_WALLETS,KEYCHAIN_MANIFEST,KEYCHAIN_RECOVERY,WALLET_METADATA_BACKUP,NOSTR_IDENTITY,BULLNYM,AUTOMATIC_FALLBACK,LIGHTNING_ADDRESS,PAYMENT_PAGE,POS,INVOICES,GET_PAID_SETTINGS,GET_PAID,REMOTE_KEYCHAIN_RECOVERY,ONBOARDING,FEES,WALLETS,EXCHANGE,APP_STARTUP,UTXO_MGMT,ADDRESS_MGMT,RECIPIENTS,FUNDING,BACKUPS,SWAPS,PAYJOIN,WITHDRAWAL,STATUS,SEND,RECEIVE,TRANSFER,TX_HISTORY,BG_TASKS,AUTOSWAPS,AUTOSWEEP,DCA,SELL,PAY,BUY,COINS featureStyle
```
