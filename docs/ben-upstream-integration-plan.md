...
- **Distributed private storage:** private retrieval authorization and the optional password-encrypted server descriptor copy remain the existing roadmap's decisions. They do not block a core restack or offline prototype preservation.
